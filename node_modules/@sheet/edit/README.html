          ...
          <div class="repository-content">
            <div id="readme" class="readme boxed-group clearfix announce instapaper_body md">
              ...
              <article class="markdown-body entry-content" itemprop="text" id="grip-content">
                <h1>
<a id="user-content-sheetjs-pro" class="anchor" href="#sheetjs-pro" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a><a href="http://sheetjs.com" rel="nofollow">SheetJS Pro</a>
</h1>
<p>The <a href="https://docs.sheetjs.com/" rel="nofollow">community edition documentation</a> covers basic
API and functionality.  This build includes the following features:</p>
<p>(note: the easiest way to explore this document is to search for keywords and
...
clicking on "Click to show")</p>
<h2>
<a id="user-content-importing-and-exporting-with-styles" class="anchor" href="#importing-and-exporting-with-styles" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Importing and Exporting with Styles</h2>
<p>The <code>cellStyles</code> option should be passed to the <code>read</code> and <code>write</code> functions:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> wb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>test.xlsx<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span> <span class="pl-c1">true</span>});
<span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>out.xlsx<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span> <span class="pl-c1">true</span>});</pre></div>
<h3>
<a id="user-content-color-objects" class="anchor" href="#color-objects" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Color Objects</h3>
<p>The most consistent way to specify a color is with a RGB string or hex code:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-smi">ws</span>.<span class="pl-c1">A1</span>.<span class="pl-smi">s</span> <span class="pl-k">=</span> { color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>FF0000<span class="pl-pds">"</span></span> }}; <span class="pl-c"><span class="pl-c">//</span> red</span></pre></div>
<details>
  <summary><b>Other color specifications</b> (click to show)</summary>
<p>For round-tripping worksheet styles, it is also possible to use a color from the
default system theme:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-smi">ws</span>.<span class="pl-c1">A2</span>.<span class="pl-smi">s</span> <span class="pl-k">=</span> { color<span class="pl-k">:</span> { theme<span class="pl-k">:</span> <span class="pl-c1">1</span>, tint<span class="pl-k">:</span> <span class="pl-c1">0.4</span> }};</pre></div>
<p>There is also a basic palette accessible as "indexed" colors:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-smi">ws</span>.<span class="pl-c1">A2</span>.<span class="pl-smi">s</span> <span class="pl-k">=</span> { color<span class="pl-k">:</span> { index<span class="pl-k">:</span> <span class="pl-c1">12</span> }};</pre></div>
</details>
<h3>
<a id="user-content-text-styling" class="anchor" href="#text-styling" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Text Styling</h3>
<p>Each cell has a style object accessible at the <code>.s</code> key of the cell, following
the schema:</p>
<table>
<thead>
<tr>
...
<td align="left">Set to <code>true</code> to bold the cell text</td>
</tr>
<tr>
<td align="left"><code>italic</code></td>
<td align="left">Set to <code>true</code> to italicize the cell text</td>
</tr>
<tr>
<td align="left"><code>underline</code></td>
<td align="left">1 = single, 2 = double</td>
</tr>
<tr>
<td align="left"><code>sz</code></td>
<td align="left">Font size in pts (e.g. 10, 12, 14)</td>
</tr>
<tr>
<td align="left"><code>strike</code></td>
<td align="left">Set to <code>true</code> for strike-through effect</td>
</tr>
<tr>
...
<td align="left">Color object</td>
</tr>
<tr>
<td align="left"><code>valign</code></td>
<td align="left">Vertical alignment: <code>sub</code> (subscript) <code>super</code> (superscript)</td>
</tr>
</tbody>
</table>
<p>For example, the following worksheet tests bold and italic:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> ws <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">aoa_to_sheet</span>([
  ...
  [<span class="pl-s"><span class="pl-pds">"</span>Bold<span class="pl-pds">"</span></span>],
  [<span class="pl-s"><span class="pl-pds">"</span>Italic<span class="pl-pds">"</span></span>],
  [<span class="pl-s"><span class="pl-pds">"</span>B+I<span class="pl-pds">"</span></span>],
]);

ws[<span class="pl-s"><span class="pl-pds">"</span>A2<span class="pl-pds">"</span></span>].<span class="pl-smi">s</span> <span class="pl-k">=</span> { bold<span class="pl-k">:</span> <span class="pl-c1">true</span> };
ws[<span class="pl-s"><span class="pl-pds">"</span>A3<span class="pl-pds">"</span></span>].<span class="pl-smi">s</span> <span class="pl-k">=</span> { italic<span class="pl-k">:</span> <span class="pl-c1">true</span> };
ws[<span class="pl-s"><span class="pl-pds">"</span>A4<span class="pl-pds">"</span></span>].<span class="pl-smi">s</span> <span class="pl-k">=</span> { bold<span class="pl-k">:</span> <span class="pl-c1">true</span>, italic<span class="pl-k">:</span> <span class="pl-c1">true</span> };</pre></div>
<h4>
<a id="user-content-rich-text" class="anchor" href="#rich-text" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Rich Text</h4>
<p>For more advanced text styling, the <code>.R</code> key of a cell can be set to an array of
cell objects.  The writer will apply the relevant style to each individual block
and concatenate the result.</p>
<p>For example, the following cell will contain the text "<b>bold</b><i>italic</i>"
where <code>bold</code> is bold and <code>italic</code> is italicized:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>A1<span class="pl-pds">"</span></span>].<span class="pl-c1">R</span> <span class="pl-k">=</span> [
  {t<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">'</span>s<span class="pl-pds">'</span></span>, v<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">'</span>bold<span class="pl-pds">'</span></span>, s<span class="pl-k">:</span>{bold<span class="pl-k">:</span><span class="pl-c1">true</span>}},
  {t<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">'</span>s<span class="pl-pds">'</span></span>, v<span class="pl-k">:</span><span class="pl-s"><span class="pl-pds">'</span>italic<span class="pl-pds">'</span></span>, s<span class="pl-k">:</span>{italic<span class="pl-k">:</span><span class="pl-c1">true</span>}},
];</pre></div>
<p>If the rich text array is specified, it will be used in lieu of the <code>.v</code> text.</p>
<h3>
<a id="user-content-cell-alignment-and-wrapping" class="anchor" href="#cell-alignment-and-wrapping" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cell Alignment and Wrapping</h3>
<p>Cell Alignment properties are controlled in the <code>alignment</code> key of the style
object.  The supported <code>alignment</code> features are explained in the table below:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<td align="left">Horizontal alignment: <code>"left" "center" "right" "justify"</code>
</td>
</tr>
<tr>
<td align="left"><code>vertical</code></td>
<td align="left">Vertical alignment: <code>"top" "center" "bottom"</code>
</td>
</tr>
<tr>
<td align="left"><code>indent</code></td>
<td align="left">Indent level (zero-indexed, 0 is default, 7 is maximum)</td>
</tr>
<tr>
<td align="left"><code>wrapText</code></td>
<td align="left">If <code>true</code>, text is wrapped: <code>\n</code> chars appear as new lines</td>
</tr>
<tr>
<td align="left"><code>textRotation</code></td>
<td align="left">Text rotation in degrees</td>
</tr>
</tbody>
</table>
<p>For example, the following cell will contain the wrapped text <code>"a\nb\nc"</code>, using
top vertical alignment and left horizontal alignment:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>A1<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> {
  t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>s<span class="pl-pds">"</span></span>, <span class="pl-c"><span class="pl-c">/*</span> string cell <span class="pl-c">*/</span></span>
  v<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>a<span class="pl-cce">\n</span>b<span class="pl-cce">\n</span>c<span class="pl-pds">"</span></span>, <span class="pl-c"><span class="pl-c">/*</span> use standard \n newline.  do not include \r <span class="pl-c">*/</span></span>
  s<span class="pl-k">:</span> {
    alignment<span class="pl-k">:</span> {
      horizontal<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>left<span class="pl-pds">"</span></span>,
      vertical<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>top<span class="pl-pds">"</span></span>,
      wrapText<span class="pl-k">:</span> <span class="pl-c1">true</span>
    }
  }
};</pre></div>
<p>The following sample stresses the 9 alignment pairs and text wrapping:</p>
<details>
  <summary><b>Alignment Example</b> (click to show)</summary>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> ws <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">aoa_to_sheet</span>([
  [<span class="pl-s"><span class="pl-pds">"</span>TL<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>TC<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>TR<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>a<span class="pl-cce">\n</span>b<span class="pl-cce">\n</span>c<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>a<span class="pl-cce">\n</span>b<span class="pl-cce">\n</span>c<span class="pl-pds">"</span></span>],
  [<span class="pl-s"><span class="pl-pds">"</span>CL<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>CC<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>CR<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>d<span class="pl-cce">\n</span>e<span class="pl-cce">\n</span>f<span class="pl-pds">"</span></span>],
  [<span class="pl-s"><span class="pl-pds">"</span>BL<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>BC<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>BR<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>g<span class="pl-cce">\n</span>h<span class="pl-cce">\n</span>i<span class="pl-pds">"</span></span>],
]);

<span class="pl-c"><span class="pl-c">/*</span> --- Horizontal Alignment --- <span class="pl-c">*/</span></span>
<span class="pl-c"><span class="pl-c">/*</span> Left-align   A1:A3 <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>A1:A3<span class="pl-pds">"</span></span>, {alignment<span class="pl-k">:</span> { horizontal<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>left<span class="pl-pds">"</span></span> }});
<span class="pl-c"><span class="pl-c">/*</span> Center-align B1:B3 <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>B1:B3<span class="pl-pds">"</span></span>, {alignment<span class="pl-k">:</span> { horizontal<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>center<span class="pl-pds">"</span></span> }});
<span class="pl-c"><span class="pl-c">/*</span> Right-align  C1:C3 <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>C1:C3<span class="pl-pds">"</span></span>, {alignment<span class="pl-k">:</span> { horizontal<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>right<span class="pl-pds">"</span></span> }});

<span class="pl-c"><span class="pl-c">/*</span> --- Vertical Alignment --- <span class="pl-c">*/</span></span>
<span class="pl-c"><span class="pl-c">/*</span> Top-align    A1:C1 <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>A1:C1<span class="pl-pds">"</span></span>, {alignment<span class="pl-k">:</span> { vertical<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>top<span class="pl-pds">"</span></span> }});
<span class="pl-c"><span class="pl-c">/*</span> Center-align A2:C2 <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>A2:C2<span class="pl-pds">"</span></span>, {alignment<span class="pl-k">:</span> { vertical<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>center<span class="pl-pds">"</span></span> }});
<span class="pl-c"><span class="pl-c">/*</span> Bottom-align A3:C3 <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>A3:C3<span class="pl-pds">"</span></span>, {alignment<span class="pl-k">:</span> { vertical<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>bottom<span class="pl-pds">"</span></span> }});

<span class="pl-c"><span class="pl-c">/*</span> --- Wrap D1:D4 (leave E1 unwrapped) --- <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>D1:D3<span class="pl-pds">"</span></span>, {alignment<span class="pl-k">:</span> { wrapText<span class="pl-k">:</span> <span class="pl-c1">true</span> }});</pre></div>
</details>
<h3>
<a id="user-content-cell-background" class="anchor" href="#cell-background" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cell Background</h3>
<p>To set a solid cell background, assign to the <code>.s.fgColor</code> property:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-smi">ws</span>.<span class="pl-c1">A3</span>.<span class="pl-smi">s</span> <span class="pl-k">=</span> { fgColor<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-c1">0xFF0000</span> } }; <span class="pl-c"><span class="pl-c">//</span> green background</span></pre></div>
<h3>
<a id="user-content-cell-borders" class="anchor" href="#cell-borders" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cell Borders</h3>
<p>The <code>s.top</code>, <code>s.bottom</code>, <code>s.left</code> and <code>s.right</code> properties control cell borders.
They are shaped as follows:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<td align="left">border type (see below)</td>
</tr>
<tr>
<td align="left"><code>color</code></td>
<td align="left">color object</td>
...
<p>The valid border values are</p>
<table>
<thead>
<tr>
<th align="left">border value</th>
<th align="left">HTML <code>border-style</code> equivalent (if applicable)</th>
</tr>
</thead>
<tbody>
<tr>
...
<tr>
<td align="left"><code>thin</code></td>
<td align="left"><code>solid</code></td>
</tr>
<tr>
<td align="left"><code>medium</code></td>
<td align="left">(drawn as <code>solid 2px</code>)</td>
</tr>
<tr>
<td align="left"><code>thick</code></td>
<td align="left">
<code>double</code> (drawn as <code>solid 3px</code>)</td>
</tr>
<tr>
...
<tr>
<td align="left"><code>hair</code></td>
<td align="left">(drawn as <code>solid</code>)</td>
</tr>
<tr>
...
<tr>
<td align="left"><code>mediumDashed</code></td>
<td align="left">(drawn as <code>dashed 2px</code>)</td>
</tr>
<tr>
<td align="left"><code>dashDot</code></td>
<td align="left">(drawn as <code>dashed</code>)</td>
</tr>
<tr>
<td align="left"><code>mediumDashDot</code></td>
<td align="left">(drawn as <code>dashed 2px</code>)</td>
</tr>
<tr>
<td align="left"><code>dashDotDot</code></td>
<td align="left">(drawn as <code>dotted</code>)</td>
</tr>
<tr>
<td align="left"><code>mediumDashDotDot</code></td>
<td align="left">(drawn as <code>dotted 2px</code>)</td>
</tr>
<tr>
<td align="left"><code>slantDashDot</code></td>
<td align="left">(drawn as <code>dashed</code>)</td>
</tr>
</tbody>
</table>
<p>For example:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>A4<span class="pl-pds">"</span></span>].<span class="pl-smi">s</span> <span class="pl-k">=</span> {
  top<span class="pl-k">:</span> { style<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>thin<span class="pl-pds">"</span></span> }, <span class="pl-c"><span class="pl-c">//</span> thin black border on top</span>
  bottom<span class="pl-k">:</span> { style<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>thick<span class="pl-pds">"</span></span>, color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-c1">0xFF0000</span> } }, <span class="pl-c"><span class="pl-c">//</span> red thick border</span>
  left<span class="pl-k">:</span> { style<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>dashed<span class="pl-pds">"</span></span>, color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-c1">0x00FF00</span> } } <span class="pl-c"><span class="pl-c">//</span> green dashed border</span>
}</pre></div>
<h3>
<a id="user-content-cell-widths" class="anchor" href="#cell-widths" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cell Widths</h3>
<p>Excel calculates column widths on save.  For new files, use the column object
<code>.auto</code> property to trigger a calculation when the file is saved:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">if</span>(<span class="pl-k">!</span>ws[<span class="pl-s"><span class="pl-pds">'</span>!cols<span class="pl-pds">'</span></span>]) ws[<span class="pl-s"><span class="pl-pds">'</span>!cols<span class="pl-pds">'</span></span>] <span class="pl-k">=</span> [];
ws[<span class="pl-s"><span class="pl-pds">'</span>!cols<span class="pl-pds">'</span></span>][<span class="pl-c1">1</span>] <span class="pl-k">=</span> { auto<span class="pl-k">:</span> <span class="pl-c1">1</span>}; <span class="pl-c"><span class="pl-c">//</span> set the second column to auto-fit width</span></pre></div>
<h3>
<a id="user-content-naming-styles" class="anchor" href="#naming-styles" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Naming Styles</h3>
<p>Styles are not named by default.  To force a name, set the <code>style</code> property of
the <code>.s</code> style object:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>A4<span class="pl-pds">"</span></span>].<span class="pl-smi">s</span>.<span class="pl-c1">style</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>Test Name<span class="pl-pds">"</span></span>;</pre></div>
<h3>
<a id="user-content-cell-level-protection" class="anchor" href="#cell-level-protection" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cell-Level Protection</h3>
<p>By default, worksheets are not protected.  To enable any sort of protection,
the <code>"!protect"</code> key of the worksheet object must be set.  The <code>password</code> key
...
details are available at <a href="https://docs.sheetjs.com/#worksheet-object" rel="nofollow">https://docs.sheetjs.com/#worksheet-object</a></p>
<p>When a worksheet is locked, by default all cells are locked but the formulae are
visible.  These options are adjustable on a cell level.  The cell <code>.s</code> style
object additionally supports the following properties:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<td align="left">Set to <code>true</code> to hide the formula if sheet is protected</td>
</tr>
<tr>
<td align="left"><code>editable</code></td>
<td align="left">Set to <code>true</code> to enable edits (by default cells are locked)</td>
</tr>
</tbody>
</table>
<details>
  <summary><b>Code Example</b> (click to show)</summary>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> ws <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">aoa_to_sheet</span>([[<span class="pl-c1">1</span>,<span class="pl-c1">2</span>],[<span class="pl-c1">3</span>,<span class="pl-c1">4</span>]]);
ws[<span class="pl-s"><span class="pl-pds">"</span>A1<span class="pl-pds">"</span></span>].<span class="pl-smi">f</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>2-1<span class="pl-pds">"</span></span>;  <span class="pl-c"><span class="pl-c">//</span> for illustrative purposes, assign formulae to A1:A2</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>A2<span class="pl-pds">"</span></span>].<span class="pl-smi">f</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>A1+2<span class="pl-pds">"</span></span>;

ws[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> {}; <span class="pl-c"><span class="pl-c">/*</span> enable worksheet protection <span class="pl-c">*/</span></span>

<span class="pl-c"><span class="pl-c">/*</span> hide formulae for cells A1:B1 <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>A1:B1<span class="pl-pds">"</span></span>, { hidden<span class="pl-k">:</span> <span class="pl-c1">true</span> });
<span class="pl-c"><span class="pl-c">/*</span> enable editing for cells A1:A2 <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>A1:A2<span class="pl-pds">"</span></span>, { editable<span class="pl-k">:</span> <span class="pl-c1">true</span> });</pre></div>
</details>
<p>Since cell-level protection is associated with the cell style, the option
<code>cellStyles: true</code> must be set when writing with <code>write</code> or <code>writeFile</code>.</p>
<h3>
...
<p><code>XLSX.utils.sheet_set_range_style</code> applies a style to a range of cells.  Text
and background styles are applied to every cell, while <code>top</code> / <code>bottom</code> / <code>left</code>
/ <code>right</code> borders are applied to the exterior sides of the range.</p>
<p>In addition to the standard options from the style object, the following keys
are supported:</p>
<table>
<thead>
<tr>
...
<td align="left">Number format (function will set cell <code>.z</code> property of each cell)</td>
</tr>
<tr>
<td align="left"><code>incol</code></td>
<td align="left">Interior Vertical border (applied to every non-exterior border)</td>
</tr>
<tr>
<td align="left"><code>inrow</code></td>
<td align="left">Interior Horizontal border (applied to every non-exterior border)</td>
</tr>
</tbody>
</table>
<p>The interior borders are applied to every applicable cell:</p>
<ul>
<li>
<code>incol</code> sets the <code>left</code> border for every cell not in the first column and sets
the <code>right</code> border for every cell not in the last column.</li>
<li>
<code>inrow</code> sets the <code>top</code> border for every cell not in the first row and sets the
<code>bottom</code> border for every cell not in the last row.</li>
</ul>
<p>For example, given the sheet</p>
<pre><code>XXX| A | B | C | D |
---+---+---+---+---+
 1 | 1 | 2 | 3 | 4 |
 2 | 5 | 6 | 7 | 8 |
 3 | 9 | A | B | C |
...
<p>This code will set:</p>
<ul>
<li>background and text color for every cell in <code>B2:C3</code> and</li>
<li>left border of cells <code>B2:B3</code>
</li>
<li>right border of cells <code>C2:C3</code>
</li>
<li>top border of cells <code>B2:C2</code>
</li>
<li>bottom border of cells <code>B3:C3</code>
</li>
</ul>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(
  ws, <span class="pl-c"><span class="pl-c">//</span> worksheet</span>
  <span class="pl-s"><span class="pl-pds">"</span>B2:C3<span class="pl-pds">"</span></span>, <span class="pl-c"><span class="pl-c">//</span> range</span>
  { <span class="pl-c"><span class="pl-c">//</span> style object</span>
    fgColor<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-c1">0x0000FF</span> }, <span class="pl-c"><span class="pl-c">//</span> blue solid background</span>
    color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-c1">0xFFFFFF</span> }, <span class="pl-c"><span class="pl-c">//</span> white text</span>
    top<span class="pl-k">:</span> { style<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>thick<span class="pl-pds">"</span></span>, color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-c1">0xFFFF00</span> } }, <span class="pl-c"><span class="pl-c">//</span> thick yellow border</span>
    bottom<span class="pl-k">:</span> { style<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>thick<span class="pl-pds">"</span></span>, color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-c1">0xFF0000</span> } }, <span class="pl-c"><span class="pl-c">//</span> red thick border</span>
    left<span class="pl-k">:</span> { style<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>dashed<span class="pl-pds">"</span></span>, color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-c1">0x00FF00</span> } } <span class="pl-c"><span class="pl-c">//</span> green dashed border</span>
  }
);</pre></div>
<p>Set a style to <code>false</code> to remove (e.g. <code>bold: false</code> will remove bold cells)</p>
<h2>
<a id="user-content-worksheet-and-workbook-protection" class="anchor" href="#worksheet-and-workbook-protection" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Worksheet and Workbook Protection</h2>
<p>There are various forms of protection.  Some are informational, and others
...
do not include Crypto features.</p>
<h3>
<a id="user-content-workbook-read-protection-password-to-open" class="anchor" href="#workbook-read-protection-password-to-open" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Workbook Read Protection (Password to Open)</h3>
<p>To read a password-protected file, pass the option <code>password</code>:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> wb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>password.xlsx<span class="pl-pds">"</span></span>, {password<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>sheetjs<span class="pl-pds">"</span></span>});</pre></div>
<p>To write a password-protected file, pass the option <code>password</code>:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>password.xlsx<span class="pl-pds">"</span></span>, {password<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Sh33tJ5<span class="pl-pds">"</span></span>});</pre></div>
<p><strong>NOTE: this is only supported in a build with the Crypto component.</strong></p>
<details>
  <summary><b>Details and Example</b> (click to show)</summary>
<p>The most effective way to test the "password to open" is to attempt to read the
file with the password.  If the password is incorrect, the reader will throw an
error with message <code>"Incorrect Password"</code></p>
<p>The following script in NodeJS will</p>
<ul>
<li>read a normal file with no password</li>
<li>create a new file with password "sheetjs"</li>
<li>fail to read the file back with no password / wrong password</li>
<li>successfully read the file back with the correct password</li>
</ul>
<div class="highlight highlight-source-js"><pre><span class="pl-c"><span class="pl-c">/*</span> Read normal file <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> wb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>original.xlsx<span class="pl-pds">"</span></span>);

<span class="pl-c"><span class="pl-c">/*</span> Generate new file with password "sheetjs" <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>pwd.xlsx<span class="pl-pds">"</span></span>, {password<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>sheetjs<span class="pl-pds">"</span></span>});

<span class="pl-c"><span class="pl-c">/*</span> Attempt to read file with no password / incorrect password <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> good <span class="pl-k">=</span> <span class="pl-c1">true</span>;
<span class="pl-k">try</span> { <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>pwd.xlsx<span class="pl-pds">"</span></span>); good<span class="pl-k">=</span><span class="pl-c1">false</span>; } <span class="pl-k">catch</span>(e){}
<span class="pl-k">try</span> { <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>pwd.xlsx<span class="pl-pds">"</span></span>, {password<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>foobar<span class="pl-pds">"</span></span>}); good<span class="pl-k">=</span><span class="pl-c1">false</span>; } <span class="pl-k">catch</span>(e){}
<span class="pl-k">if</span>(<span class="pl-k">!</span>good) <span class="pl-k">throw</span> <span class="pl-k">new</span> <span class="pl-en">Error</span>(<span class="pl-s"><span class="pl-pds">"</span>read failed to reject bad password<span class="pl-pds">"</span></span>);

<span class="pl-c"><span class="pl-c">/*</span> Read the file with the correct password <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> newwb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>pwd.xlsx<span class="pl-pds">"</span></span>, {password<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>sheetjs<span class="pl-pds">"</span></span>});</pre></div>
</details>
<h3>
<a id="user-content-informational-password-protection" class="anchor" href="#informational-password-protection" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Informational" Password Protection</h3>
<p>Other forms of password protection, including "Password to Modify", are optional
insofar as the application is expected to honor the protection but nothing stops
a program from bypassing the protection.</p>
<h4>
<a id="user-content-workbook-modify-protection-password-to-modify" class="anchor" href="#workbook-modify-protection-password-to-modify" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Workbook Modify Protection (Password to Modify)</h4>
<p>The workbook <code>.Workbook.Modify</code> object, if defined, stores the metadata.  The
following keys are used:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<td align="left">if true, show a warning before permitting write access</td>
</tr>
<tr>
<td align="left"><code>user</code></td>
<td align="left">User name that set the protection (will be shown in messages)</td>
</tr>
<tr>
<td align="left"><code>encryption</code></td>
<td align="left">Encryption metadata (explained below)</td>
</tr>
</tbody>
</table>
<div class="highlight highlight-source-js"><pre><span class="pl-k">if</span>(<span class="pl-k">!</span><span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span>) <span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span> <span class="pl-k">=</span> {};
<span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span>.<span class="pl-smi">Modify</span> <span class="pl-k">=</span> { warn<span class="pl-k">:</span> <span class="pl-c1">true</span>, user<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Sheet JS<span class="pl-pds">"</span></span> };
<span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span>.<span class="pl-smi">Modify</span>.<span class="pl-smi">encryption</span> <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">hash_password</span>(<span class="pl-s"><span class="pl-pds">"</span>sheetjs<span class="pl-pds">"</span></span>);</pre></div>
<h4>
<a id="user-content-workbook-properties-protection-protect-workbook" class="anchor" href="#workbook-properties-protection-protect-workbook" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Workbook Properties Protection (Protect Workbook)</h4>
<p>The Workbook Properties Protection are found in the "Review" Ribbon tab or under
Tools ... Protect ... Protect Workbook in the menus.  They are stored in the
workbook under <code>.Workbook.Protection</code>:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<tbody>
<tr>
<td align="left"><code>lockStructure</code></td>
<td align="left">Sheets cannot be moved, deleted, (un)hidden, or renamed.</td>
</tr>
<tr>
<td align="left"><code>lockWindows</code></td>
<td align="left">Windows are the same size and in the same position</td>
</tr>
<tr>
<td align="left"><code>encryption</code></td>
<td align="left">Encryption metadata (explained below)</td>
...
<div class="highlight highlight-source-js"><pre><span class="pl-k">if</span>(<span class="pl-k">!</span><span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span>) <span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span> <span class="pl-k">=</span> {};
<span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span>.<span class="pl-smi">Protection</span> <span class="pl-k">=</span> { lockStructure<span class="pl-k">:</span> <span class="pl-c1">true</span> };
<span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span>.<span class="pl-smi">Protection</span>.<span class="pl-smi">encryption</span> <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">hash_password</span>(<span class="pl-s"><span class="pl-pds">"</span>sheetjs<span class="pl-pds">"</span></span>);</pre></div>
<h4>
<a id="user-content-worksheet-properties-protection-protect-workbook" class="anchor" href="#worksheet-properties-protection-protect-workbook" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Worksheet Properties Protection (Protect Workbook)</h4>
<p>The Worksheet Properties Protection are found in the "Review" Ribbon tab or in
Tools ... Protect ... Protect Worksheet in the menus.  They are stored in the
worksheet under the <code>!protect</code> key:</p>
<details>
...
<div class="highlight highlight-source-js"><pre><span class="pl-k">if</span>(<span class="pl-k">!</span>ws[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>]) ws[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> {};
ws[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>].<span class="pl-smi">selectLockedCells</span> <span class="pl-k">=</span> <span class="pl-c1">false</span>;
ws[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>].<span class="pl-smi">encryption</span> <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">hash_password</span>(<span class="pl-s"><span class="pl-pds">"</span>sheetjs<span class="pl-pds">"</span></span>);</pre></div>
<h4>
<a id="user-content-working-with-informational-passwords" class="anchor" href="#working-with-informational-passwords" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Working with Informational Passwords</h4>
<p>The <code>encryption</code> key of the informational protection objects store metadata
pertaining to the password.  Utility functions for working with the metadata are
available in Pro builds with the Crypto component:</p>
<ul>
<li>
<p><code>test_password(encryption, password)</code> tests whether the password is correct,
returning <code>true</code> or <code>false</code>.  As shown in the examples, since the parent
protection object may not exist, code should always test for the existence:</p>
</li>
<li>
<p><code>hash_password(password)</code> creates an encryption object:</p>
</li>
</ul>
<details>
  <summary><b>Examples</b> (click to show)</summary>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> testpwd <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>SheetJS<span class="pl-pds">"</span></span>;

<span class="pl-c"><span class="pl-c">/*</span> Test Workbook Properties password <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> wbenc <span class="pl-k">=</span> ((<span class="pl-smi">wb</span>.<span class="pl-smi">Workbook</span> <span class="pl-k">||</span> {}).<span class="pl-smi">Protection</span> <span class="pl-k">||</span> {}).<span class="pl-smi">encryption</span>;
<span class="pl-k">var</span> wbtest <span class="pl-k">=</span> wbenc <span class="pl-k">?</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">test_password</span>(wbenc, testpwd) <span class="pl-k">:</span> <span class="pl-c1">true</span>;

<span class="pl-c"><span class="pl-c">/*</span> Test Worksheet Properties password <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> ws <span class="pl-k">=</span> <span class="pl-smi">wb</span>.<span class="pl-smi">Sheets</span>[<span class="pl-s"><span class="pl-pds">"</span>Sheet1<span class="pl-pds">"</span></span>];
<span class="pl-k">var</span> wsenc <span class="pl-k">=</span> (ws[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>] <span class="pl-k">||</span> {}).<span class="pl-smi">encryption</span>;
<span class="pl-k">var</span> wstest <span class="pl-k">=</span> wsenc <span class="pl-k">?</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">test_password</span>(wsenc, testpwd) <span class="pl-k">:</span> <span class="pl-c1">true</span>;

<span class="pl-c"><span class="pl-c">/*</span> Set Worksheet Password <span class="pl-c">*/</span></span>
<span class="pl-k">if</span>(<span class="pl-k">!</span><span class="pl-smi">wb</span>.<span class="pl-smi">Sheets</span>.<span class="pl-smi">Sheet2</span>[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>]) <span class="pl-smi">wb</span>.<span class="pl-smi">Sheets</span>.<span class="pl-smi">Sheet2</span>[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> {};
<span class="pl-smi">wb</span>.<span class="pl-smi">Sheets</span>.<span class="pl-smi">Sheet2</span>[<span class="pl-s"><span class="pl-pds">"</span>!protect<span class="pl-pds">"</span></span>].<span class="pl-smi">encryption</span> <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">hash_password</span>(<span class="pl-s"><span class="pl-pds">"</span>SheetJS<span class="pl-pds">"</span></span>);</pre></div>
</details>
<h2>
<a id="user-content-print-settings" class="anchor" href="#print-settings" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Print Settings</h2>
<p>Print settings are generally stored in the <code>"!print"</code> key of the worksheet.  For
backwards compatibility, legacy key names are supported but not documented here.</p>
<details>
  <summary><b>Example Print Settings</b> (click to show)</summary>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> {

  <span class="pl-c"><span class="pl-c">/*</span> Print area A1:E50 <span class="pl-c">*/</span></span>
  area<span class="pl-k">:</span> { s<span class="pl-k">:</span>{r<span class="pl-k">:</span><span class="pl-c1">0</span>, c<span class="pl-k">:</span><span class="pl-c1">0</span>}, e<span class="pl-k">:</span>{c<span class="pl-k">:</span><span class="pl-c1">4</span>,r<span class="pl-k">:</span><span class="pl-c1">49</span>} },

  <span class="pl-c"><span class="pl-c">/*</span> Forced row break at row 3-4 <span class="pl-c">*/</span></span>
  rowBreaks<span class="pl-k">:</span> [{<span class="pl-c1">R</span><span class="pl-k">:</span><span class="pl-c1">3</span>}],

  <span class="pl-c"><span class="pl-c">/*</span> Forced column break at column C-D <span class="pl-c">*/</span></span>
  colBreaks<span class="pl-k">:</span> [{<span class="pl-c1">C</span><span class="pl-k">:</span><span class="pl-c1">3</span>}],

  <span class="pl-c"><span class="pl-c">/*</span> margins <span class="pl-c">*/</span></span>
  margins<span class="pl-k">:</span> {
    left<span class="pl-k">:</span> <span class="pl-c1">0.7</span>,
    right<span class="pl-k">:</span> <span class="pl-c1">0.6</span>,
    top<span class="pl-k">:</span> <span class="pl-c1">0.5</span>,
    bottom<span class="pl-k">:</span> <span class="pl-c1">0.4</span>,
    header<span class="pl-k">:</span> <span class="pl-c1">0.3</span>,
    footer<span class="pl-k">:</span> <span class="pl-c1">0.2</span>
  },

  <span class="pl-c"><span class="pl-c">/*</span> raw header string <span class="pl-c">*/</span></span>
  header<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>&amp;&amp;SheetJS<span class="pl-pds">"</span></span>,

  <span class="pl-c"><span class="pl-c">/*</span> parameterized footer settings <span class="pl-c">*/</span></span>
  footer<span class="pl-k">:</span> {
    odd<span class="pl-k">:</span> {
      center<span class="pl-k">:</span> { <span class="pl-c1">R</span><span class="pl-k">:</span> [
        {w<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>&amp;A<span class="pl-pds">"</span></span>, s<span class="pl-k">:</span> { bold<span class="pl-k">:</span> <span class="pl-c1">true</span> } },
        {w<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>&amp;D<span class="pl-pds">"</span></span>, s<span class="pl-k">:</span> { italic<span class="pl-k">:</span> <span class="pl-c1">true</span> } },
        {w<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>&amp;F<span class="pl-pds">"</span></span>, s<span class="pl-k">:</span> { underline<span class="pl-k">:</span> <span class="pl-c1">true</span> } },
        {w<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>red<span class="pl-pds">"</span></span>, s<span class="pl-k">:</span> { color<span class="pl-k">:</span> {rgb<span class="pl-k">:</span> <span class="pl-c1">0xFF0000</span> } } },
        {w<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>&amp;Z<span class="pl-pds">"</span></span>, s<span class="pl-k">:</span> { underline<span class="pl-k">:</span> <span class="pl-c1">2</span>, strike<span class="pl-k">:</span> <span class="pl-c1">true</span>}}
      ] }
    },
    even<span class="pl-k">:</span> {
      right<span class="pl-k">:</span> { w<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>&amp;I&amp;D&amp;I<span class="pl-pds">"</span></span> },
      left<span class="pl-k">:</span> { w<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>&amp;A<span class="pl-pds">"</span></span>, s<span class="pl-k">:</span> { bold<span class="pl-k">:</span> <span class="pl-c1">true</span> } }
    }
  },

  <span class="pl-c"><span class="pl-c">/*</span> other properties <span class="pl-c">*/</span></span>
  props<span class="pl-k">:</span> {
    orientation<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>landscape<span class="pl-pds">"</span></span>,
    paper<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Legal<span class="pl-pds">"</span></span>,
    dpi<span class="pl-k">:</span> <span class="pl-c1">1200</span>,
    first<span class="pl-k">:</span> <span class="pl-c1">3</span>,
    comments<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>displayed<span class="pl-pds">"</span></span>,
    errors<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>n/a<span class="pl-pds">"</span></span>,
    gridlines<span class="pl-k">:</span> <span class="pl-c1">true</span>,
    bw<span class="pl-k">:</span> <span class="pl-c1">true</span>,
    draft<span class="pl-k">:</span> <span class="pl-c1">true</span>,
    headings<span class="pl-k">:</span> <span class="pl-c1">true</span>,
    order<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>over<span class="pl-pds">"</span></span>,
    centerX<span class="pl-k">:</span> <span class="pl-c1">false</span>,
    centerY<span class="pl-k">:</span> <span class="pl-c1">true</span>,
    scale<span class="pl-k">:</span> <span class="pl-c1">50</span> <span class="pl-c"><span class="pl-c">//</span> this sets 50% scale</span>
    <span class="pl-c"><span class="pl-c">//</span>fit: { width: 2, height: 3 } // this force fits to 2 pages x 3 pages</span>
  }
};
</pre></div>
</details>
<h3>
<a id="user-content-print-area" class="anchor" href="#print-area" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Print Area</h3>
<p>Print area is normally represented in the defined name <code>_xlnm.Print_Area</code> scoped
to the specific worksheet.  The library automatically copies and decodes the
range to the <code>.area</code> property of the worksheet.  On write, if the print area is
specified, the defined name will be re-written!</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c"><span class="pl-c">/*</span> set print area to A1:D20 <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">area</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>A1:D20<span class="pl-pds">"</span></span>;                              <span class="pl-c"><span class="pl-c">//</span> range string</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">area</span> <span class="pl-k">=</span> { s<span class="pl-k">:</span> { r<span class="pl-k">:</span><span class="pl-c1">0</span>, c<span class="pl-k">:</span><span class="pl-c1">0</span> }, e<span class="pl-k">:</span> { r<span class="pl-k">:</span><span class="pl-c1">19</span>, c<span class="pl-k">:</span><span class="pl-c1">3</span> } }; <span class="pl-c"><span class="pl-c">//</span> range object</span></pre></div>
<h3>
<a id="user-content-print-options" class="anchor" href="#print-options" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Print Options</h3>
<p>Various print options are stored in the <code>.props</code> key of the print object:</p>
<h4>
<a id="user-content-orientation" class="anchor" href="#orientation" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Orientation</h4>
<p><code>.orientation</code> marks the page orientation, valid values are <code>"landscape"</code> for
landscape, <code>"portrait"</code> for portrait, and <code>"default"</code> for printer default.</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">orientation</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>landscape<span class="pl-pds">"</span></span>; <span class="pl-c"><span class="pl-c">//</span> landscape</span></pre></div>
<h4>
<a id="user-content-scaling" class="anchor" href="#scaling" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Scaling</h4>
<p><code>.fit</code> enables the "Fit to Page" print option.  The fit object supports the
<code>width</code> and <code>height</code> properties indicating the number of pages to fit.  The
default value is 1 for width and 1 for height:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">fit</span> <span class="pl-k">=</span> { width<span class="pl-k">:</span> <span class="pl-c1">3</span>, height<span class="pl-k">:</span> <span class="pl-c1">4</span> };</pre></div>
<p><code>.scale</code> is the integral percentage print scale, defaulting to 100 (for 100%).
The scale must be between 10 (10%) and 400 (4x).  This option only applies when
fit is not specified!</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">scale</span> <span class="pl-k">=</span> <span class="pl-c1">50</span>; <span class="pl-c"><span class="pl-c">//</span> 50%</span></pre></div>
<h4>
<a id="user-content-paper-size--type" class="anchor" href="#paper-size--type" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Paper Size / Type</h4>
<p><code>.paper</code> controls the Paper size.  It can be set to a numeric or string value,
as described in the table below, or to an object with <code>width</code> and <code>height</code>
properties whose values must be strings that include a distance unit.</p>
<details>
...
<td align="left">8.5 in x 11 in</td>
<td align="left">Letter Paper</td>
</tr>
<tr>
<td align="right">2</td>
<td align="left"></td>
<td align="left">8.5 in x 11 in</td>
<td align="left">Letter Small Paper</td>
</tr>
<tr>
<td align="right">3</td>
<td align="left">Tabloid</td>
<td align="left">11 in x 17 in</td>
<td align="left">Tabloid Paper</td>
</tr>
<tr>
<td align="right">4</td>
<td align="left"></td>
<td align="left">17 in x 11 in</td>
<td align="left">Ledger Paper</td>
</tr>
<tr>
<td align="right">5</td>
<td align="left">Legal</td>
<td align="left">8.5 in x 14 in</td>
<td align="left">Legal Paper</td>
</tr>
<tr>
<td align="right">6</td>
<td align="left"></td>
<td align="left">5.5 in x 8.5 in</td>
<td align="left">Ledger Paper</td>
</tr>
<tr>
<td align="right">7</td>
<td align="left">Executive</td>
<td align="left">7.25 in x 10.5 in</td>
<td align="left">Executive Paper</td>
</tr>
<tr>
<td align="right">8</td>
<td align="left">A3</td>
<td align="left">297 mm x 420 mm</td>
<td align="left">A3 Paper</td>
</tr>
<tr>
<td align="right">9</td>
<td align="left">A4</td>
<td align="left">210 mm x 297 mm</td>
<td align="left">A4 Paper</td>
</tr>
<tr>
<td align="right">10</td>
<td align="left"></td>
<td align="left">210 mm x 297 mm</td>
<td align="left">A4 Small Paper</td>
</tr>
<tr>
<td align="right">11</td>
<td align="left">A5</td>
<td align="left">148 mm x 210 mm</td>
<td align="left">A5 Paper</td>
</tr>
<tr>
<td align="right">12</td>
<td align="left">B4</td>
<td align="left">257 mm x 364 mm</td>
<td align="left">B4 (JIS)</td>
</tr>
<tr>
<td align="right">13</td>
<td align="left">B5</td>
<td align="left">182 mm x 257 mm</td>
<td align="left">B5 (JIS)</td>
</tr>
<tr>
<td align="right">14</td>
<td align="left">Folio</td>
<td align="left">8.5 in x 13 in</td>
<td align="left">Folio paper</td>
</tr>
<tr>
<td align="right">20</td>
<td align="left">Envelope</td>
<td align="left">4.125 in x 9.5 in</td>
<td align="left">Envelope #10</td>
</tr>
<tr>
<td align="right">27</td>
<td align="left"></td>
<td align="left">110 mm x 220 mm</td>
<td align="left">Envelope DL</td>
</tr>
<tr>
<td align="right">28</td>
<td align="left"></td>
<td align="left">162 mm x 229 mm</td>
<td align="left">Envelope C5</td>
</tr>
<tr>
<td align="right">29</td>
<td align="left"></td>
<td align="left">324 mm x 458 mm</td>
<td align="left">Envelope C3</td>
</tr>
<tr>
<td align="right">30</td>
<td align="left"></td>
<td align="left">229 mm x 324 mm</td>
<td align="left">Envelope C4</td>
</tr>
<tr>
<td align="right">31</td>
<td align="left"></td>
<td align="left">114 mm x 162 mm</td>
<td align="left">Envelope C6</td>
</tr>
<tr>
<td align="right">34</td>
<td align="left"></td>
<td align="left">175 mm x 250 mm</td>
<td align="left">Envelope B5</td>
</tr>
<tr>
<td align="right">37</td>
<td align="left">Monarch</td>
<td align="left">3.875 in x 7.5 in</td>
<td align="left">Envelope Monarch</td>
</tr>
<tr>
<td align="right">43</td>
<td align="left"></td>
<td align="left">100 mm x 148 mm</td>
<td align="left">Japanese Postcard</td>
</tr>
<tr>
<td align="right">69</td>
<td align="left"></td>
<td align="left">200 mm x 148 mm</td>
<td align="left">Japanese Double Postcard</td>
</tr>
<tr>
<td align="right">70</td>
<td align="left">A6</td>
<td align="left">105 mm x 148 mm</td>
<td align="left">A6 Paper</td>
</tr>
</tbody>
</table>
</details>
<p>For example, the standard "#10 envelope" paper can be set in a few ways:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">paper</span> <span class="pl-k">=</span> <span class="pl-c1">20</span>;                                    <span class="pl-c"><span class="pl-c">//</span> code</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">paper</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>Envelope<span class="pl-pds">"</span></span>;                            <span class="pl-c"><span class="pl-c">//</span> alias</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">paper</span> <span class="pl-k">=</span> { height<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>4.125in<span class="pl-pds">"</span></span>, width<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>9.5in<span class="pl-pds">"</span></span> }; <span class="pl-c"><span class="pl-c">//</span> size</span></pre></div>
<h4>
<a id="user-content-print-quality" class="anchor" href="#print-quality" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Print Quality</h4>
<p><code>.dpi</code> controls the print quality.  The standard options differ between versions
but the standard options in Excel 2019 are 600 (default) and 1200.</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">dpi</span> <span class="pl-k">=</span> <span class="pl-c1">600</span>;</pre></div>
<h4>
<a id="user-content-first-page-number" class="anchor" href="#first-page-number" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>First Page Number</h4>
<p><code>.first</code> controls the first page number.  If it is not specified or set to null,
the first page number is automatically determined:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">first</span> <span class="pl-k">=</span> <span class="pl-c1">3</span>; <span class="pl-c"><span class="pl-c">//</span> First Page Number 3</span></pre></div>
<h4>
<a id="user-content-centering-content-in-the-pages" class="anchor" href="#centering-content-in-the-pages" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Centering Content in the Pages</h4>
<p>By default, content is aligned to the upper-left corner of the content region.</p>
<p>The <code>.centerX</code> and <code>.centerY</code> properties control the alignment.  If <code>centerX</code> is
true, then the content will be centered horizontally within the region.  The
<code>centerY</code> property does the same for the vertical axis.</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">centerX</span> <span class="pl-k">=</span> <span class="pl-c1">true</span>;  <span class="pl-c"><span class="pl-c">//</span> center horizontally</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">centerY</span> <span class="pl-k">=</span> falss; <span class="pl-c"><span class="pl-c">//</span> align to top of content region</span></pre></div>
<h4>
<a id="user-content-print-features" class="anchor" href="#print-features" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Print Features</h4>
<p>There are 4 checkbox options:</p>
<table>
<thead>
<tr>
<th align="left">
<code>.props</code> property</th>
<th align="left">UI Description</th>
</tr>
</thead>
<tbody>
<tr>
<td align="left"><code>.gridlines</code></td>
<td align="left">Print Gridlines</td>
</tr>
<tr>
<td align="left"><code>.bw</code></td>
<td align="left">Print Black and White</td>
</tr>
<tr>
<td align="left"><code>.draft</code></td>
<td align="left">Print Draft quality (without graphics)</td>
</tr>
<tr>
<td align="left"><code>.headings</code></td>
<td align="left">Print Row and Column Headings</td>
</tr>
</tbody>
</table>
<p>The <code>.comments</code> property describes how cell comments are displayed on print:</p>
<table>
<thead>
<tr>
<th align="left"><code>.comments</code></th>
<th align="left">UI Description</th>
</tr>
</thead>
<tbody>
...
<td align="left">"As displayed on sheet"</td>
</tr>
<tr>
<td align="left">"end"</td>
<td align="left">"At end of sheet"</td>
</tr>
<tr>
...
<p>The <code>.errors</code> property describes how cells with errors are displayed on print:</p>
<table>
<thead>
<tr>
<th align="left"><code>.errors</code></th>
<th align="left">UI Description</th>
</tr>
</thead>
<tbody>
...
<td align="left">"NA"  (error)</td>
</tr>
</tbody>
</table>
<p>For example:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">comments</span>   <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>displayed<span class="pl-pds">"</span></span>;
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">errors</span>     <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>displayed<span class="pl-pds">"</span></span>;
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">gridlines</span>  <span class="pl-k">=</span> <span class="pl-c1">false</span>;
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">bw</span>         <span class="pl-k">=</span> <span class="pl-c1">true</span>;
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">draft</span>      <span class="pl-k">=</span> <span class="pl-c1">false</span>;
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">headings</span>   <span class="pl-k">=</span> <span class="pl-c1">true</span>;</pre></div>
<h4>
<a id="user-content-page-order" class="anchor" href="#page-order" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Page Order</h4>
<p>The <code>.order</code> property should be set to <code>true</code> or <code>"over"</code> for "Over, then down"
page order.  The default value is "Down, then over".</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">order</span> <span class="pl-k">=</span> <span class="pl-c1">true</span>;  <span class="pl-c"><span class="pl-c">//</span> "Over, then down"</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">props</span>.<span class="pl-smi">order</span> <span class="pl-k">=</span> <span class="pl-c1">false</span>; <span class="pl-c"><span class="pl-c">//</span> "Down, then over"</span></pre></div>
<h3>
<a id="user-content-page-margins" class="anchor" href="#page-margins" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Page Margins</h3>
<p>The <code>.margins</code> key of the print object is an object which stores all of the page
margins in inches.  The legacy <code>ws["!margins"]</code> object is also supported.  The
key properties are listed below:</p>
<details>
...
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">margins</span> <span class="pl-k">=</span> {left<span class="pl-k">:</span><span class="pl-c1">0.7</span>,  right<span class="pl-k">:</span><span class="pl-c1">0.7</span>,  top<span class="pl-k">:</span><span class="pl-c1">0.75</span>, bottom<span class="pl-k">:</span><span class="pl-c1">0.75</span>, header<span class="pl-k">:</span><span class="pl-c1">0.3</span>, footer<span class="pl-k">:</span><span class="pl-c1">0.3</span> };
<span class="pl-c"><span class="pl-c">/*</span> Set worksheet sheet to "wide" <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">margins</span> <span class="pl-k">=</span> {left<span class="pl-k">:</span><span class="pl-c1">1.0</span>,  right<span class="pl-k">:</span><span class="pl-c1">1.0</span>,  top<span class="pl-k">:</span><span class="pl-c1">1.0</span>,  bottom<span class="pl-k">:</span><span class="pl-c1">1.0</span>,  header<span class="pl-k">:</span><span class="pl-c1">0.5</span>, footer<span class="pl-k">:</span><span class="pl-c1">0.5</span> };
<span class="pl-c"><span class="pl-c">/*</span> Set worksheet sheet to "narrow" <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">margins</span> <span class="pl-k">=</span> {left<span class="pl-k">:</span><span class="pl-c1">0.25</span>, right<span class="pl-k">:</span><span class="pl-c1">0.25</span>, top<span class="pl-k">:</span><span class="pl-c1">0.75</span>, bottom<span class="pl-k">:</span><span class="pl-c1">0.75</span>, header<span class="pl-k">:</span><span class="pl-c1">0.3</span>, footer<span class="pl-k">:</span><span class="pl-c1">0.3</span> };</pre></div>
</details>
<h3>
<a id="user-content-row-and-column-breaks" class="anchor" href="#row-and-column-breaks" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Row and Column Breaks</h3>
<p>Row and Column Breaks determine the rows and columns where Excel forces a new
page.  This does not control any other natural page breaks, merely forcing
breaks at the specified points.</p>
<p>The <code>.rowBreaks</code> of the print object is an array of row break objects.  Each row
break has a single <code>R</code> field indicating the first zero-indexed row of the break:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c"><span class="pl-c">/*</span> Force breaks between rows 3-4, 7-8 <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">rowBreaks</span> <span class="pl-k">=</span> [ {<span class="pl-c1">R</span><span class="pl-k">:</span><span class="pl-c1">3</span>}, {<span class="pl-c1">R</span><span class="pl-k">:</span><span class="pl-c1">7</span>} ];</pre></div>
<p>The <code>.colBreaks</code> of the print object is an array of column break objects.  Each
column break has a single <code>C</code> field for the first zero-indexed column:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c"><span class="pl-c">/*</span> Force breaks between columns C-D, G-H <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">colBreaks</span> <span class="pl-k">=</span> [ {<span class="pl-c1">C</span><span class="pl-k">:</span><span class="pl-c1">3</span>}, {<span class="pl-c1">C</span><span class="pl-k">:</span><span class="pl-c1">7</span>} ];</pre></div>
<h3>
<a id="user-content-header-and-footer" class="anchor" href="#header-and-footer" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Header and Footer</h3>
<p>Internally, Excel stores header and footer strings for odd pages, even pages,
...
the writers are a bit more flexible and support more idiomatic forms.</p>
<h4>
<a id="user-content-general-structure" class="anchor" href="#general-structure" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>General Structure</h4>
<p>The <code>.header</code> and <code>.footer</code> fields correspond to the header and footer.</p>
<p>Within each of those objects, the <code>.odd</code>, <code>.even</code>, and <code>.first</code> keys correspond
to the Odd-numbered pages, Even-numbered pages, and first page respectively.</p>
<p>By default, if the <code>.even</code> key is not specified, the <code>.odd</code> header/footer will
apply to even-numbered pages.  If the <code>.first</code> key is not specified, the <code>.odd</code>
header/footer will also apply to the first page.  To clear either format,
explicitly set it to an empty string:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c"><span class="pl-c">/*</span> Apply header to every page except the first <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">header</span> <span class="pl-k">=</span> {
  odd<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Hello World!<span class="pl-pds">"</span></span>,
  first<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span><span class="pl-pds">"</span></span>
};
<span class="pl-c"><span class="pl-c">/*</span> Apply footer to first page and even pages but not odd pages <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">footer</span> <span class="pl-k">=</span> {
  first<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>First page yo!<span class="pl-pds">"</span></span>,
  even<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Even steven!<span class="pl-pds">"</span></span>,
  odd<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span><span class="pl-pds">"</span></span>
};</pre></div>
<h4>
<a id="user-content-header-and-footer-format-representation" class="anchor" href="#header-and-footer-format-representation" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Header and Footer Format Representation</h4>
<p>The internal representation uses <code>&amp;</code>-prefixed control specifiers and is a bit
clumsy for programmatic use.  For pass-through purposes, this form is supported,
but the library also supports other forms.</p>
<p><strong>Pass-through Strings</strong></p>
<p>The Official VBA documentation describes the formatting codes in the article
<a href="https://docs.microsoft.com/en-us/office/vba/excel/Concepts/Workbooks-and-Worksheets/formatting-and-vba-codes-for-headers-and-footers" rel="nofollow">"Formatting and VBA codes for headers and footers"</a>.</p>
<details>
  <summary><b>Header and Footer Strings</b> (click to show)</summary>
<p><em>Position</em></p>
<p>By default, if no positioning specifiers are included, the header/footer is
centered.  The specifiers indicate that the following text and specifiers apply
to the indicated position.</p>
<table>
<thead>
<tr>
...
<td align="left">Center section</td>
</tr>
<tr>
<td align="left"><code>&amp;L</code></td>
<td align="left">Left section</td>
</tr>
<tr>
<td align="left"><code>&amp;R</code></td>
<td align="left">Right section</td>
</tr>
</tbody>
</table>
<div class="highlight highlight-source-js"><pre><span class="pl-c"><span class="pl-c">/*</span> Write to different sections <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">footer</span>.<span class="pl-smi">odd</span><span class="pl-k">=</span> (<span class="pl-s"><span class="pl-pds">"</span>&amp;L<span class="pl-pds">"</span></span> <span class="pl-k">+</span> <span class="pl-s"><span class="pl-pds">"</span>Left<span class="pl-pds">"</span></span>) <span class="pl-k">+</span> (<span class="pl-s"><span class="pl-pds">"</span>&amp;C<span class="pl-pds">"</span></span> <span class="pl-k">+</span> <span class="pl-s"><span class="pl-pds">"</span>Center<span class="pl-pds">"</span></span> ) <span class="pl-k">+</span> (<span class="pl-s"><span class="pl-pds">"</span>&amp;R<span class="pl-pds">"</span></span> <span class="pl-k">+</span> <span class="pl-s"><span class="pl-pds">"</span>Right<span class="pl-pds">"</span></span>)
<span class="pl-c"><span class="pl-c">//</span>                       |-Left--------|   |-----Center-----|   |--------Right-|</span></pre></div>
<p><em>Special Data</em></p>
<p>Fields like Page Number are specified as follows:</p>
<table>
<thead>
<tr>
<th align="left">Spec</th>
...
<tr>
<td align="left"><code>&amp;P+###</code></td>
<td align="left">Page Number + specified number</td>
</tr>
<tr>
<td align="left"><code>&amp;P+###</code></td>
<td align="left">Page Number - specified number</td>
...
<td align="left">Page Count (<code>Page &amp;P of &amp;N)</code>
</td>
</tr>
<tr>
<td align="left"><code>&amp;D</code></td>
<td align="left">Current Date</td>
</tr>
<tr>
...
<td align="left">Worksheet Name</td>
</tr>
<tr>
...
<tr>
<td align="left"><code>&amp;&amp;</code></td>
<td align="left">Literal <code>&amp;</code>
</td>
</tr>
</tbody>
</table>
<p>For example, the following code sets footer center to <code>Page # of #</code>:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">footer</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>&amp;CPage &amp;P of &amp;N<span class="pl-pds">"</span></span>;</pre></div>
<p><em>Text Styles</em></p>
<p>The text styling logic is state-based.  The individual operators toggle state.
For example, <code>&amp;B</code> is the bold token, so the text "foo<strong>bold</strong>bar" is saved as</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!print<span class="pl-pds">"</span></span>].<span class="pl-smi">footer</span>.<span class="pl-smi">odd</span> <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>foo&amp;Bbold&amp;Bbar<span class="pl-pds">"</span></span>
<span class="pl-c"><span class="pl-c">//</span> off------------------------^^on--^^off-</span></pre></div>
<table>
<thead>
<tr>
<th align="left">Spec</th>
...
<td align="left">Toggle Underline **</td>
</tr>
<tr>
<td align="left"><code>&amp;E</code></td>
<td align="left">Toggle Double-Underline **</td>
</tr>
<tr>
<td align="left"><code>&amp;H</code></td>
<td align="left">Toggle Shadow</td>
</tr>
<tr>
<td align="left"><code>&amp;O</code></td>
<td align="left">Toggle Outline</td>
</tr>
<tr>
<td align="left"><code>&amp;X</code></td>
<td align="left">Toggle Superscript **</td>
</tr>
<tr>
<td align="left"><code>&amp;Y</code></td>
<td align="left">Toggle Subscript **</td>
</tr>
<tr>
<td align="left"><code>&amp;S</code></td>
<td align="left">Toggle Strike-through</td>
</tr>
<tr>
<td align="left"><code>&amp;K...</code></td>
<td align="left">Font color (RRGGBB or theme+tint) **</td>
</tr>
<tr>
<td align="left"><code>&amp;#</code></td>
<td align="left">Text size in points (<code>&amp;16</code> is 16 pt size)</td>
</tr>
<tr>
<td align="left"><code>&amp;"..."</code></td>
<td align="left">Font name</td>
...
<tr>
<td align="left"><code>&amp;"+"</code></td>
<td align="left">Use the current theme Heading font</td>
</tr>
<tr>
<td align="left"><code>&amp;"-"</code></td>
<td align="left">Use the current theme Body font</td>
</tr>
</tbody>
</table>
<p>The underline modes and vertical alignment are mutually exclusive, so turning on
one will disable the other.  For example, the format code <code>&amp;XFoo&amp;YBar&amp;XBaz</code> will
write <code>Foo</code> in superscript, <code>Bar</code> in subscript, and <code>Baz</code> in superscript.</p>
<p>Font color is specified in one of two ways: standard RGB string (<code>FF0000</code> = Red)
or Theme and Tint (<code>##S###</code> where the first two digits running from <code>00</code> to <code>12</code>
specify the theme color, <code>S</code> is either "+" or "-", and <code>###</code> is a percentage
running from 000 to 100)</p>
</details>
<h2>
<a id="user-content-data-validations" class="anchor" href="#data-validations" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Data Validations</h2>
<p>Data Validations are stored in the <code>!validations</code> array of the worksheet:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">'</span>!validations<span class="pl-pds">'</span></span>] <span class="pl-k">=</span> [
  <span class="pl-c"><span class="pl-c">/*</span> A1:A5 show a fixed dropdown menu with specified values <span class="pl-c">*/</span></span>
  {
    ref<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>A1:A5<span class="pl-pds">'</span></span>,
    t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>List<span class="pl-pds">'</span></span>,
    l<span class="pl-k">:</span> [<span class="pl-s"><span class="pl-pds">"</span>a<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>b<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>c<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>d<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>e<span class="pl-pds">"</span></span>],
		input<span class="pl-k">:</span> {
			title<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Letter<span class="pl-pds">"</span></span>,
			message<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Type a letter a,b,c,d,e<span class="pl-pds">"</span></span>
		}
  },
  <span class="pl-c"><span class="pl-c">/*</span> B1:B5 are restricted to integers between 0 and 10, blanks not ignored <span class="pl-c">*/</span></span>
  {
    ref<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>B1:B5<span class="pl-pds">'</span></span>,
    t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>Whole<span class="pl-pds">'</span></span>,
    op<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>IN<span class="pl-pds">'</span></span>,
    blank<span class="pl-k">:</span> <span class="pl-c1">false</span>,
    min<span class="pl-k">:</span> <span class="pl-c1">0</span>,
    max<span class="pl-k">:</span> <span class="pl-c1">10</span>
  }
]</pre></div>
<p>Each validation object in the array follows the schema:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<td align="left">Range or cell string or address object</td>
</tr>
<tr>
<td align="left"><code>t</code></td>
<td align="left">Type of Data Validation (see table)</td>
</tr>
<tr>
<td align="left"><code>l</code></td>
<td align="left">Array of strings for a fixed dropdown List</td>
</tr>
<tr>
<td align="left"><code>f</code></td>
<td align="left">Formula or Range for Custom or List DV</td>
</tr>
<tr>
<td align="left"><code>op</code></td>
<td align="left">Data operator (see below)</td>
</tr>
<tr>
<td align="left"><code>min/max/v</code></td>
<td align="left">Min / Max / Exact values for the operator</td>
</tr>
<tr>
<td align="left"><code>blank</code></td>
<td align="left">"Ignore Blank" (set to <code>false</code> to disable)</td>
</tr>
<tr>
<td align="left"><code>input</code></td>
<td align="left">Input Message (see below)</td>
</tr>
<tr>
<td align="left"><code>error</code></td>
<td align="left">Error Alert (see below)</td>
</tr>
</tbody>
</table>
<p>The <code>ref</code> reference can be passed as a string ("A2" or "A2:C4") or address
object like <code>{r:1, c:0}</code> or range like <code>{s:{r:1,c:0}, e:{r:3,c:2}}</code>.</p>
<h3>
<a id="user-content-data-validation-types" class="anchor" href="#data-validation-types" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Data Validation Types</h3>
<p>The <code>type</code> refers to the "Allow" option in the Settings tab of Data Validation:</p>
<table>
<thead>
<tr>
<th align="left">type</th>
<th align="left">Excel interface name</th>
...
<td align="left">"Any Value"</td>
<td align="center">No</td>
<td align="left"></td>
</tr>
<tr>
<td align="left"><code>"Whole"</code></td>
<td align="left">"Whole number"</td>
<td align="center">Yes</td>
<td align="left">
<code>min</code> + <code>max</code> OR <code>v</code>
</td>
</tr>
<tr>
...
<h3>
<a id="user-content-data-validation-operators" class="anchor" href="#data-validation-operators" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Data Validation Operators</h3>
<p>For the numeric data validations, ranges are specified in terms of operators:</p>
<table>
<thead>
<tr>
...
<h3>
<a id="user-content-input-message" class="anchor" href="#input-message" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Input Message</h3>
<p>By default, "Show input message when cell is selected" is enabled.  To disable,
set the <code>input</code> property to <code>false</code>.</p>
<p>If the <code>input</code> property is assigned a value, it is expected to be an object with
...
<td align="left">"Input message"</td>
</tr>
</tbody>
</table>
<h3>
<a id="user-content-error-alert" class="anchor" href="#error-alert" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Error Alert</h3>
<p>By default, "Show error alert after invalid data is entered" is enabled.  To
disable, set the <code>error</code> property to <code>false</code></p>
<p>If the <code>error</code> property is assigned a value, it is expected to be an object with
the following fields:</p>
<table>
<thead>
<tr>
...
<td align="left">"Style", expected to be "stop" or "warning" or "info"</td>
</tr>
</tbody>
</table>
<h2>
<a id="user-content-conditional-formatting" class="anchor" href="#conditional-formatting" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Conditional Formatting</h2>
<p>Conditional Formats are stored in the <code>!condfmt</code> array of the worksheet:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">'</span>!condfmt<span class="pl-pds">'</span></span>] <span class="pl-k">=</span> [
  <span class="pl-c"><span class="pl-c">/*</span> A1:A10 "Format only values that are above average" GT <span class="pl-c">*/</span></span>
  {
    ref<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>A1:A10<span class="pl-pds">"</span></span>,
    t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>avg<span class="pl-pds">"</span></span>,
    op<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>GT<span class="pl-pds">"</span></span>,
    <span class="pl-c"><span class="pl-c">/*</span> "Light Red Fill with Dark Red Text" <span class="pl-c">*/</span></span>
    s<span class="pl-k">:</span> { color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>9C0006<span class="pl-pds">'</span></span> }, bgColor<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>FFC7CE<span class="pl-pds">'</span></span> } }
  },
  <span class="pl-c"><span class="pl-c">/*</span> B1:B10 "Format all cells based on their values" (2-Color Scale) <span class="pl-c">*/</span></span>
  {
    ref<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>B1:B10<span class="pl-pds">"</span></span>,
    t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>scale<span class="pl-pds">"</span></span>,
    <span class="pl-c"><span class="pl-c">/*</span> Minimum type Percent value 25 default orange <span class="pl-c">*/</span></span>
    cmin<span class="pl-k">:</span> { v<span class="pl-k">:</span> <span class="pl-c1">25</span>, t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>percent<span class="pl-pds">'</span></span>, color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>FF7128<span class="pl-pds">'</span></span> } },
    <span class="pl-c"><span class="pl-c">/*</span> Maximum type Percent value 75 default yellow <span class="pl-c">*/</span></span>
    cmax<span class="pl-k">:</span> { v<span class="pl-k">:</span> <span class="pl-c1">75</span>, t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>percent<span class="pl-pds">'</span></span>, color<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>FFEF9C<span class="pl-pds">'</span></span> } } }
  }
];</pre></div>
<p>Each conditional format object in the array follows the schema:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<tr>
<td align="left"><code>t</code></td>
<td align="left">Type of Conditional Format (listed below)</td>
</tr>
<tr>
<td align="left"><code>s</code></td>
<td align="left">Differential Style (when relevant)</td>
</tr>
<tr>
<td align="left"><code>op</code></td>
<td align="left">Data operator (when relevant)</td>
</tr>
<tr>
<td align="left"><code>f</code></td>
<td align="left">Formula (when relevant)</td>
</tr>
<tr>
<td align="left"><code>min/max/v</code></td>
<td align="left">Min / Max / Exact values (when relevant)</td>
</tr>
<tr>
<td align="left"><code>color</code></td>
<td align="left">Data Bar Color</td>
</tr>
<tr>
<td align="left"><code>cmin/cmax</code></td>
<td align="left">Threshold Objects (Data Bar / Color Scale)</td>
</tr>
<tr>
<td align="left"><code>cmid</code></td>
<td align="left">Middle Threshold (Color Scale)</td>
</tr>
<tr>
<td align="left"><code>thresh</code></td>
<td align="left">Array of Threshold Objects (Icon Set)</td>
</tr>
</tbody>
</table>
<p>The <code>ref</code> reference can be passed as a string ("A2" or "A2:C4") or address
object like <code>{r:1, c:0}</code> or range like <code>{s:{r:1,c:0}, e:{r:3,c:2}}</code>.</p>
<p>Note: Since CF is read and written when <code>cellStyles: true</code> is set, the easiest
way to construct a specific CF is to create a test file using it, parsing using
<code>read</code> or <code>readFile</code>, and logging the conditional formatting array.</p>
<h3>
<a id="user-content-conditional-formatting-types" class="anchor" href="#conditional-formatting-types" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Conditional Formatting Types</h3>
<p>The UI mapping is explained below:</p>
<table>
<thead>
<tr>
<th align="left">type</th>
...
<td align="left">Format only values that are above or below average</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>bar</code></td>
<td align="left">Format all cells based on values: Data Bars</td>
<td align="left"></td>
</tr>
<tr>
<td align="left"><code>blank</code></td>
<td align="left">Format only cells that contain: Blanks or no Blanks</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>date</code></td>
<td align="left">Format only cells that contain: Dates Occurring</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>dup</code></td>
<td align="left">Format all duplicate values</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>error</code></td>
<td align="left">Format only cells that contain: Errors or No Errors</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>formula</code></td>
<td align="left">Format values where formula is true</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>icon</code></td>
<td align="left">Format all cells based on values: Icon Sets</td>
<td align="left"></td>
</tr>
<tr>
<td align="left"><code>rank</code></td>
<td align="left">Format only top or bottom ranked values</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>scale</code></td>
<td align="left">Format all cells based on values: 2- or 3- color scale</td>
<td align="left"></td>
</tr>
<tr>
<td align="left"><code>text</code></td>
<td align="left">Format only cells that contain: Specific Text</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>unique</code></td>
<td align="left">Format all unique values</td>
<td align="left">Yes</td>
</tr>
<tr>
<td align="left"><code>val</code></td>
<td align="left">Format only cells that contain: Cell Value</td>
<td align="left">Yes</td>
</tr>
</tbody>
</table>
<h3>
<a id="user-content-differential-styles" class="anchor" href="#differential-styles" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Differential Styles</h3>
<p>For the "classic" conditional formatting, the <code>s</code> style is interpreted as a
"differential" style, applied on top of the cell's existing style.  This extends
the standard style representation by interpreting <code>null</code> items as disabling
features:</p>
<div class="highlight highlight-source-js"><pre>{ t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>avg<span class="pl-pds">"</span></span>, ref<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>A1:A10<span class="pl-pds">"</span></span>, op<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>GT<span class="pl-pds">"</span></span>,
  s<span class="pl-k">:</span> {
    b<span class="pl-k">:</span> <span class="pl-c1">true</span>, <span class="pl-c"><span class="pl-c">/*</span> turn on bold <span class="pl-c">*/</span></span>
    left<span class="pl-k">:</span> <span class="pl-c1">null</span> <span class="pl-c"><span class="pl-c">/*</span> remove left border <span class="pl-c">*/</span></span>
  }
}</pre></div>
<h3>
<a id="user-content-conditional-formatting-rules" class="anchor" href="#conditional-formatting-rules" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Conditional Formatting Rules</h3>
<p>The explanation is spelled out in accordance with the user interface:</p>
<h4>
<a id="user-content-format-all-cells-based-on-their-values-color-scales" class="anchor" href="#format-all-cells-based-on-their-values-color-scales" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format all cells based on their values": Color Scales</h4>
<p>Type <code>scale</code> corresponds to the format styles "(2/3)-Color Scale".</p>
<details>
...
<tbody>
<tr>
<td align="left"><code>cmin</code></td>
<td align="left">Parameters for "Minimum" threshold</td>
</tr>
<tr>
<td align="left"><code>cmid</code></td>
<td align="left">Parameters for "Midpoint" threshold (3-Color Scale only)</td>
</tr>
<tr>
<td align="left"><code>cmax</code></td>
<td align="left">Parameters for "Maximum" threshold</td>
</tr>
</tbody>
</table>
<p>The Color Scale thresholds include both threshold data and color info:</p>
<table>
<thead>
<tr>
<th align="left">thresh key</th>
<th align="left">UI description</th>
</tr>
</thead>
<tbody>
<tr>
<td align="left"><code>t</code></td>
<td align="left">Threshold Type (see below)</td>
</tr>
<tr>
<td align="left"><code>v/f</code></td>
<td align="left">Threshold Value</td>
</tr>
<tr>
<td align="left"><code>color</code></td>
<td align="left">Color specification</td>
</tr>
</tbody>
</table>
<p>The Color Scale threshold types are described below:</p>
<table>
<thead>
<tr>
<th align="left">thresh type</th>
<th align="left">UI Description</th>
...
<td align="left">
<code>cmin</code> only</td>
<td align="left"></td>
</tr>
<tr>
<td align="left"><code>max</code></td>
<td align="left">Highest Value</td>
<td align="left">
<code>cmax</code> only</td>
<td align="left"></td>
</tr>
<tr>
...
<tr>
<td align="left"><code>percent</code></td>
...
<tr>
<td align="left"><code>percentile</code></td>
...
<h4>
<a id="user-content-format-all-cells-based-on-their-values-data-bars" class="anchor" href="#format-all-cells-based-on-their-values-data-bars" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format all cells based on their values": Data Bars</h4>
<p>Type <code>bar</code> corresponds to the format style "Data Bar".</p>
<details>
...
<p>The Data Bar thresholds include threshold data but no color info:</p>
<table>
<thead>
<tr>
<th align="left">thresh key</th>
...
<p>The Data Bar threshold types are described below:</p>
<table>
<thead>
<tr>
<th align="left">thresh type</th>
...
<h4>
<a id="user-content-format-all-cells-based-on-their-values-icon-sets" class="anchor" href="#format-all-cells-based-on-their-values-icon-sets" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format all cells based on their values": Icon Sets</h4>
<p>Type <code>icon</code> corresponds to the format style "Icon Sets".</p>
<details>
...
<tr>
<td align="left"><code>thresh</code></td>
<td align="left">Array of threshold objects</td>
</tr>
<tr>
<td align="left"><code>v</code></td>
<td align="left">Icon type (see below)</td>
</tr>
<tr>
<td align="left"><code>hidden</code></td>
<td align="left">If true, "Show Icon Only"</td>
</tr>
</tbody>
</table>
<p>The icon types and expected number of threshold objects are listed below:</p>
<table>
<thead>
<tr>
<th align="left">icon type</th>
<th align="left">thresh count</th>
<th align="left">UI description</th>
</tr>
</thead>
<tbody>
<tr>
<td align="left"><code>3Arrows</code></td>
<td align="left"><code>3</code></td>
<td align="left">3 Arrows (Colored)</td>
</tr>
<tr>
<td align="left"><code>3ArrowsGray</code></td>
<td align="left"><code>3</code></td>
<td align="left">3 Arrows (Gray)</td>
</tr>
<tr>
<td align="left"><code>3Flags</code></td>
<td align="left"><code>3</code></td>
<td align="left">3 Flags</td>
</tr>
<tr>
<td align="left"><code>3TrafficLights1</code></td>
<td align="left"><code>3</code></td>
<td align="left">3 Traffic Lights (unrimmed)</td>
</tr>
<tr>
<td align="left"><code>3TrafficLights2</code></td>
<td align="left"><code>3</code></td>
<td align="left">3 Traffic Lights (rimmed)</td>
</tr>
<tr>
<td align="left"><code>3Signs</code></td>
<td align="left"><code>3</code></td>
<td align="left">3 Signs</td>
</tr>
<tr>
<td align="left"><code>3Symbols</code></td>
<td align="left"><code>3</code></td>
<td align="left">3 Symbols (Circled)</td>
</tr>
<tr>
<td align="left"><code>3Symbols2</code></td>
<td align="left"><code>3</code></td>
<td align="left">3 Symbols (Uncircled)</td>
</tr>
<tr>
<td align="left"><code>3Stars</code></td>
<td align="left">
<code>3</code> !!</td>
<td align="left">3 Stars</td>
</tr>
<tr>
<td align="left"><code>3Triangles</code></td>
<td align="left">
<code>3</code> !!</td>
<td align="left">3 Triangles</td>
</tr>
<tr>
<td align="left"><code>4Arrows</code></td>
<td align="left"><code>4</code></td>
<td align="left">4 Arrows (Colored)</td>
</tr>
<tr>
<td align="left"><code>4ArrowsGray</code></td>
<td align="left"><code>4</code></td>
<td align="left">4 Arrows (Gray)</td>
</tr>
<tr>
<td align="left"><code>4RedToBlack</code></td>
<td align="left"><code>4</code></td>
<td align="left">Red To Black</td>
</tr>
<tr>
<td align="left"><code>4Rating</code></td>
<td align="left"><code>4</code></td>
<td align="left">4 Ratings</td>
</tr>
<tr>
<td align="left"><code>4TrafficLights</code></td>
<td align="left"><code>4</code></td>
<td align="left">4 Traffic Lights</td>
</tr>
<tr>
<td align="left"><code>5Arrows</code></td>
<td align="left"><code>5</code></td>
<td align="left">5 Arrows (Colored)</td>
</tr>
<tr>
<td align="left"><code>5ArrowsGray</code></td>
<td align="left"><code>5</code></td>
<td align="left">5 Arrows (Gray)</td>
</tr>
<tr>
<td align="left"><code>5Rating</code></td>
<td align="left"><code>5</code></td>
<td align="left">5 Ratings</td>
</tr>
<tr>
<td align="left"><code>5Quarters</code></td>
<td align="left"><code>5</code></td>
<td align="left">5 Quarters</td>
</tr>
<tr>
<td align="left"><code>5Boxes</code></td>
<td align="left">
<code>5</code> !!</td>
<td align="left">5 Boxes</td>
</tr>
</tbody>
</table>
<p>The marked icon types are Excel extensions and may not be supported in older
versions of Excel and other spreadsheet software</p>
<p>The Icon Sets thresholds include threshold data but no color info:</p>
<table>
<thead>
<tr>
<th align="left">thresh key</th>
...
<p>The Icon Set threshold types are described below:</p>
<table>
<thead>
<tr>
<th align="left">thresh type</th>
...
<p>The first threshold in an icon set must be <code>{ t: 'percent', v: 0}</code> for proper
rendering of the first icon.</p>
<p>For example, the standard 33% / 67% Traffic Light CF is:</p>
<div class="highlight highlight-source-js"><pre>{
  ref<span class="pl-k">:</span> ‘<span class="pl-c1">E2</span><span class="pl-k">:</span><span class="pl-c1">E9</span><span class="pl-s"><span class="pl-pds">'</span>,</span>
<span class="pl-s">  t: <span class="pl-pds">'</span></span>icon<span class="pl-s"><span class="pl-pds">'</span>,</span>
<span class="pl-s">  thresh: [</span>
<span class="pl-s">    { v: 0,  t: <span class="pl-pds">'</span></span>percent<span class="pl-s"><span class="pl-pds">'</span> }, // This must always be 0 %</span>
<span class="pl-s">    { v: 33, t: <span class="pl-pds">'</span></span>percent<span class="pl-s"><span class="pl-pds">'</span> }, // 33 %</span>
<span class="pl-s">    { v: 67, t: <span class="pl-pds">'</span></span>percent<span class="pl-s"><span class="pl-pds">'</span> }  // 67 %</span>
<span class="pl-s">  ],</span>
<span class="pl-s">  v: ‘3TrafficLights1<span class="pl-pds">'</span></span>
}</pre></div>
</details>
<h4>
<a id="user-content-format-only-cells-that-contain-cell-value" class="anchor" href="#format-only-cells-that-contain-cell-value" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format only cells that contain": "Cell Value"</h4>
<p>Type <code>val</code> corresponds to "Cell Value".</p>
<details>
  <summary><b>Cell Value properties</b> (click to show)</summary>
<p>The differential style <code>s</code> option is used.</p>
<p>The <code>op</code> key specifies the operator. <code>min/max/v</code> and <code>op</code> are interpreted in the
same way as the Data Validation operator:</p>
<table>
<thead>
<tr>
<th align="left"><code>op</code></th>
<th align="left">Excel interface name</th>
<th align="left">min</th>
<th align="left">max</th>
<th align="left">v</th>
...
<h4>
<a id="user-content-format-only-cells-that-contain-specific-text" class="anchor" href="#format-only-cells-that-contain-specific-text" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format only cells that contain": "Specific Text"</h4>
<p>Type <code>text</code> corresponds to "Specific Text".</p>
<details>
  <summary><b>Specific Text properties</b> (click to show)</summary>
<p>The differential style <code>s</code> option is used.</p>
<p>The <code>v</code> key specifies the actual text value and the <code>op</code> key specifies operator:</p>
<table>
<thead>
<tr>
<th align="left"><code>op</code></th>
<th align="left">UI Definition</th>
...
<tr>
<td align="left"><code>OT</code></td>
<td align="left">not containing</td>
<td align="left">"out" (not "in")</td>
</tr>
<tr>
<td align="left"><code>ST</code></td>
<td align="left">beginning with</td>
<td align="left">start of "start"</td>
</tr>
<tr>
<td align="left"><code>ND</code></td>
<td align="left">ending with</td>
<td align="left">end of "end"</td>
</tr>
</tbody>
</table>
</details>
<h4>
<a id="user-content-format-only-cells-that-contain-dates-occurring" class="anchor" href="#format-only-cells-that-contain-dates-occurring" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format only cells that contain": "Dates Occurring"</h4>
<p>Type <code>date</code> corresponds to "Dates Occurring".</p>
<details>
  <summary><b>Dates Occurring properties</b> (click to show)</summary>
<p>The differential style <code>s</code> option is used.</p>
<p>The <code>op</code> key specifies time:</p>
<table>
<thead>
<tr>
<th align="left"><code>op</code></th>
...
<td align="left">In the last 7 days</td>
</tr>
<tr>
...
<tr>
<td align="left"><code>NW</code></td>
<td align="left">Next week</td>
</tr>
<tr>
...
<td align="left">Next month</td>
</tr>
</tbody>
</table>
</details>
<h4>
<a id="user-content-format-only-cells-that-contain-errors-blanks-no-errors-no-blanks" class="anchor" href="#format-only-cells-that-contain-errors-blanks-no-errors-no-blanks" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format only cells that contain": Errors Blanks "No Errors" "No Blanks"</h4>
<p>Type <code>error</code> corresponds to "Errors" and "No Errors".</p>
<p>Type <code>blank</code> corresponds to "Blanks" and "No Blanks".</p>
<details>
  <summary><b>Errors / Blanks properties</b> (click to show)</summary>
<p>The differential style <code>s</code> option is used.</p>
<p><code>error</code> and <code>blank</code> types use the <code>v</code> key to indicate the type:</p>
<table>
<thead>
<tr>
<th align="center"><code>v</code></th>
<th align="left">type <code>error</code>
</th>
<th align="left">type <code>blank</code>
</th>
</tr>
</thead>
<tbody>
...
<td align="left">"No Blanks"</td>
</tr>
</tbody>
</table>
</details>
<h4>
<a id="user-content-format-only-top-or-bottom-ranked-values" class="anchor" href="#format-only-top-or-bottom-ranked-values" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format only top or bottom ranked values"</h4>
<p>Type <code>rank</code> corresponds to this rule type.</p>
<details>
  <summary><b>Ranked Values properties</b> (click to show)</summary>
<p>The differential style <code>s</code> option is used.</p>
<p>The <code>v</code> key specifies a numeric value (text box in the UI).  The <code>op</code> key
specifies rank type:</p>
<table>
<thead>
<tr>
<th align="left"><code>op</code></th>
...
<th align="left">Interpretation of <code>v = 20</code>
</th>
</tr>
</thead>
<tbody>
...
<tr>
<td align="left"><code>BV</code></td>
<td align="left">"Bottom"</td>
<td align="left">Value</td>
<td align="left">Bottom 20</td>
</tr>
<tr>
<td align="left"><code>TP</code></td>
<td align="left">"Top"</td>
<td align="left">Percent</td>
<td align="left">Top 20%</td>
</tr>
...
<h4>
<a id="user-content-format-only-values-that-are-above-or-below-average" class="anchor" href="#format-only-values-that-are-above-or-below-average" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format only values that are above or below average"</h4>
<p>Type <code>avg</code> corresponds to this rule type.</p>
<details>
  <summary><b>Average properties</b> (click to show)</summary>
<p>The differential style <code>s</code> option is used.</p>
<p>The <code>op</code> key specifies operator type:</p>
<table>
<thead>
<tr>
<th align="left"><code>op</code></th>
...
<tr>
<td align="left"><code>GE</code></td>
<td align="left">"equal or above"</td>
</tr>
<tr>
<td align="left"><code>LE</code></td>
<td align="left">"equal or below"</td>
</tr>
<tr>
<td align="left"><code>G1</code></td>
<td align="left">"1 std dev above"</td>
</tr>
<tr>
<td align="left"><code>L1</code></td>
<td align="left">"1 std dev below"</td>
</tr>
<tr>
<td align="left"><code>G2</code></td>
<td align="left">"2 std dev above"</td>
</tr>
<tr>
<td align="left"><code>L2</code></td>
<td align="left">"2 std dev below"</td>
</tr>
<tr>
<td align="left"><code>G3</code></td>
<td align="left">"3 std dev above"</td>
</tr>
<tr>
<td align="left"><code>L3</code></td>
<td align="left">"3 std dev below"</td>
</tr>
</tbody>
</table>
</details>
<h4>
<a id="user-content-format-only-unique-or-duplicate-values" class="anchor" href="#format-only-unique-or-duplicate-values" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Format only unique or duplicate values"</h4>
<p>Type <code>dup</code> corresponds to "Format all duplicate values in the selected range"</p>
<p>Type <code>unique</code> corresponds to "Format all unique values in the selected range"</p>
<p>The differential style <code>s</code> option is used.</p>
<h4>
<a id="user-content-use-a-formula-to-determine-which-cells-to-format" class="anchor" href="#use-a-formula-to-determine-which-cells-to-format" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>"Use a formula to determine which cells to format"</h4>
<p>Type <code>formula</code> corresponds to this rule type.</p>
<details>
...
<tr>
<td align="left"><code>f</code></td>
<td align="left">Formula string (exactly as entered in UI formula bar)</td>
</tr>
</tbody>
</table>
</details>
<h3>
<a id="user-content-conditional-formatting-examples" class="anchor" href="#conditional-formatting-examples" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Conditional Formatting Examples</h3>
<p>A common trick for shading alternate rows in a worksheet uses a conditional
format of type <code>formula</code> using the formula <code>MOD(ROW(),2)=0</code>:</p>
<div class="highlight highlight-source-js"><pre>{
  ref<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>A1:E200<span class="pl-pds">"</span></span>, <span class="pl-c"><span class="pl-c">//</span> change to the worksheet range</span>
  t<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>formula<span class="pl-pds">"</span></span>,
  f<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>MOD(ROW(),2)=1<span class="pl-pds">"</span></span>, <span class="pl-c"><span class="pl-c">//</span> no initial =</span>
  s<span class="pl-k">:</span> { bgColor<span class="pl-k">:</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">'</span>ECECEC<span class="pl-pds">'</span></span> } } <span class="pl-c"><span class="pl-c">//</span> light gray background</span>
}</pre></div>
<h2>
<a id="user-content-miscellaneous-worksheet-properties" class="anchor" href="#miscellaneous-worksheet-properties" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Miscellaneous Worksheet Properties</h2>
<h3>
<a id="user-content-freeze-panes" class="anchor" href="#freeze-panes" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Freeze Panes</h3>
<p>Freeze panes are specified by setting the <code>!freeze</code> key of the worksheet object
...
the "Freeze pane" option in the Excel UI.</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!freeze<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>A2<span class="pl-pds">"</span></span>; <span class="pl-c"><span class="pl-c">//</span> Freeze first row               bottom pane starts at A2</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!freeze<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>B1<span class="pl-pds">"</span></span>; <span class="pl-c"><span class="pl-c">//</span> Freeze first column             right pane starts at B1</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!freeze<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>B2<span class="pl-pds">"</span></span>; <span class="pl-c"><span class="pl-c">//</span> Freeze row and column    bottom-right pane starts at B2</span></pre></div>
<h3>
<a id="user-content-tab-colors" class="anchor" href="#tab-colors" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Tab Colors</h3>
<p>Worksheet tab colors are specified by setting the <code>!tabcolor</code> key of the
worksheet object to an RGB color object:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!tabcolor<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>FF0000<span class="pl-pds">"</span></span> }; <span class="pl-c"><span class="pl-c">//</span> Red tab</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!tabcolor<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>00FF00<span class="pl-pds">"</span></span> }; <span class="pl-c"><span class="pl-c">//</span> Green tab</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!tabcolor<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> { rgb<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>0000FF<span class="pl-pds">"</span></span> }; <span class="pl-c"><span class="pl-c">//</span> Blue tab</span></pre></div>
<h3>
<a id="user-content-gridline-visibility" class="anchor" href="#gridline-visibility" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Gridline Visibility</h3>
<p>Worksheet gridlines are stored in the worksheet under the <code>"!gridlines"</code> key:</p>
<div class="highlight highlight-source-js"><pre>ws[<span class="pl-s"><span class="pl-pds">"</span>!gridlines<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> <span class="pl-c1">true</span>; <span class="pl-c"><span class="pl-c">//</span> enable gridlines</span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!gridlines<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> <span class="pl-c1">false</span>; <span class="pl-c"><span class="pl-c">//</span> disable gridlines</span>
<span class="pl-k">if</span>(ws[<span class="pl-s"><span class="pl-pds">"</span>!gridlines<span class="pl-pds">"</span></span>] <span class="pl-k">!=</span> <span class="pl-c1">null</span> <span class="pl-k">&amp;&amp;</span> <span class="pl-k">!</span>ws[<span class="pl-s"><span class="pl-pds">"</span>!gridlines<span class="pl-pds">"</span></span>]) { <span class="pl-c"><span class="pl-c">/*</span> gridlines hidden <span class="pl-c">*/</span></span> }</pre></div>
<h2>
<a id="user-content-tables" class="anchor" href="#tables" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Tables</h2>
<p>Tables are specified as objects in the <code>!tables</code> array of the worksheet.</p>
<h3>
<a id="user-content-basics" class="anchor" href="#basics" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Basics</h3>
<p>The <code>ref</code> key of the Table object specifies the range.  It can be an A1-style
string like <code>A1:B4</code> or a range object.  If the range is not specified, the
entire worksheet will be considered the table.</p>
<p>The <code>name</code> key of the Table object specifies the name.  A default autogenerated
name will be used if omitted.</p>
<p>The simplest table is therefore:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">if</span>(<span class="pl-k">!</span>ws[<span class="pl-s"><span class="pl-pds">"</span>!tables<span class="pl-pds">"</span></span>]) ws[<span class="pl-s"><span class="pl-pds">"</span>!tables<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> [];
ws[<span class="pl-s"><span class="pl-pds">"</span>!tables<span class="pl-pds">"</span></span>].<span class="pl-c1">push</span>({}); <span class="pl-c"><span class="pl-c">//</span> spans entire worksheet</span></pre></div>
<h3>
<a id="user-content-styling" class="anchor" href="#styling" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Styling</h3>
<p>Basic style properties of the Table are stored in the <code>style</code> object:</p>
<table>
<thead>
<tr>
<th align="left">key</th>
...
<tr>
<td align="left"><code>name</code></td>
<td align="left">Name of Table Style</td>
</tr>
<tr>
<td align="left"><code>rowstripe</code></td>
<td align="left">Show Row Stripes</td>
</tr>
<tr>
<td align="left"><code>colstripe</code></td>
<td align="left">Show Column Stripes</td>
</tr>
</tbody>
</table>
<p>The name of a table style takes the form <code>&lt;type&gt;&lt;id&gt;</code> where <code>type</code> is <code>"Light"</code>,
<code>"Medium"</code> or <code>"Dark"</code>.  <code>id</code> is a number starting from <code>1</code>, displayed in the
Tooltip text when hovering over a style in the "Format as Table" popup.  There
are 21 Light styles, 28 Medium styles, and 11 Dark styles.</p>
<p>The default options use the style <code>Medium9</code> with row stripes enabled and column
stripes disabled.</p>
<h3>
...
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> ws <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">aoa_to_sheet</span>([
  [<span class="pl-s"><span class="pl-pds">"</span>Item<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>Price<span class="pl-pds">"</span></span>]
]);
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_add_json</span>(ws, [
  { Item<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>abc<span class="pl-pds">"</span></span>, Price<span class="pl-k">:</span> <span class="pl-c1">1.23</span> },
  { Item<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>def<span class="pl-pds">"</span></span>, Price<span class="pl-k">:</span> <span class="pl-c1">4.56</span> },
], {origin<span class="pl-k">:</span> <span class="pl-k">-</span><span class="pl-c1">1</span>, skipHeader<span class="pl-k">:</span> <span class="pl-c1">true</span>});
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_add_json</span>(ws, [
  { Item<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>ghi<span class="pl-pds">"</span></span>, Price<span class="pl-k">:</span> <span class="pl-c1">7.89</span> },
], {origin<span class="pl-k">:</span> <span class="pl-k">-</span><span class="pl-c1">1</span>, skipHeader<span class="pl-k">:</span> <span class="pl-c1">true</span>});

ws[<span class="pl-s"><span class="pl-pds">"</span>!tables<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> [
  {
    <span class="pl-s"><span class="pl-pds">"</span>name<span class="pl-pds">"</span></span><span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>MyTable<span class="pl-pds">"</span></span>,
    <span class="pl-s"><span class="pl-pds">"</span>ref<span class="pl-pds">"</span></span><span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>A1:B4<span class="pl-pds">"</span></span>,
    <span class="pl-s"><span class="pl-pds">"</span>style<span class="pl-pds">"</span></span><span class="pl-k">:</span> {
      <span class="pl-s"><span class="pl-pds">"</span>name<span class="pl-pds">"</span></span><span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>Medium1<span class="pl-pds">"</span></span>,
      <span class="pl-s"><span class="pl-pds">"</span>rowstripe<span class="pl-pds">"</span></span><span class="pl-k">:</span> <span class="pl-c1">true</span>,
      <span class="pl-s"><span class="pl-pds">"</span>colstripe<span class="pl-pds">"</span></span><span class="pl-k">:</span> <span class="pl-c1">false</span>
    }
  }
];</pre></div>
<h2>
<a id="user-content-dom-table-ingress" class="anchor" href="#dom-table-ingress" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>DOM Table Ingress</h2>
<p>The <code>table_to_book</code> and <code>table_to_sheet</code> utility functions read CSS properties
from the specified TABLE element.</p>
<p>Style properties are read from the container TD cell by default:</p>
<div class="highlight highlight-text-html-basic"><pre>&lt;<span class="pl-ent">td</span> <span class="pl-e">style</span>=<span class="pl-s"><span class="pl-pds">"</span><span class="pl-s1"><span class="pl-c1"><span class="pl-c1">font-weight</span></span>: <span class="pl-c1">bold</span></span><span class="pl-pds">"</span></span>&gt;This is bold&lt;/<span class="pl-ent">td</span>&gt;</pre></div>
<p>If the TD cell contains a single SPAN with text, text properties from the span
are interpreted as text properties for the cell:</p>
<div class="highlight highlight-text-html-basic"><pre>&lt;<span class="pl-ent">td</span>&gt;&lt;<span class="pl-ent">span</span> <span class="pl-e">style</span>=<span class="pl-s"><span class="pl-pds">"</span><span class="pl-s1"><span class="pl-c1"><span class="pl-c1">font-weight</span></span>: <span class="pl-c1">700</span></span><span class="pl-pds">"</span></span>&gt;The cell will be bold&lt;/<span class="pl-ent">span</span>&gt;&lt;/<span class="pl-ent">td</span>&gt;</pre></div>
<p>For optimal ingress, the following styles are recommended:</p>
<div class="highlight highlight-source-css"><pre><span class="pl-c"><span class="pl-c">/*</span> Excel draws the grid as if adjacent cells share border <span class="pl-c">*/</span></span>
<span class="pl-ent">TABLE</span> { <span class="pl-c1"><span class="pl-c1">border-collapse</span></span>: <span class="pl-c1">collapse</span>; }

<span class="pl-c"><span class="pl-c">/*</span> table_to_book / table_to_sheet check width/height attributes <span class="pl-c">*/</span></span>
<span class="pl-ent">*</span> { <span class="pl-c1"><span class="pl-c1">box-sizing</span></span>: <span class="pl-c1">border-box</span>; }

<span class="pl-c"><span class="pl-c">/*</span> explicitly set cell vertical-align to middle or top or bottom <span class="pl-c">*/</span></span>
<span class="pl-ent">TH</span>, <span class="pl-ent">TD</span> { <span class="pl-c1"><span class="pl-c1">vertical-align</span></span>: <span class="pl-c1">middle</span>; }</pre></div>
<h3>
<a id="user-content-cell-properties-and-rich-text" class="anchor" href="#cell-properties-and-rich-text" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cell Properties and Rich Text</h3>
<p>If a cell contains multiple nodes, it will be interpreted as a rich text run:</p>
<blockquote>
<p>The cell is normal, but <strong>this fragment is bold</strong></p>
</blockquote>
<div class="highlight highlight-text-html-basic"><pre>&lt;<span class="pl-ent">td</span>&gt;The cell is normal, but &lt;<span class="pl-ent">b</span>&gt;this fragment is bold&lt;/<span class="pl-ent">b</span>&gt;&lt;/<span class="pl-ent">td</span>&gt;</pre></div>
<p>Cell properties like background color will still be read from the TD element:</p>
<div class="highlight highlight-text-html-basic"><pre>&lt;<span class="pl-ent">td</span> <span class="pl-e">bgcolor</span>=<span class="pl-s"><span class="pl-pds">"</span>red<span class="pl-pds">"</span></span>&gt;This cell will have red background &lt;<span class="pl-ent">b</span>&gt;even in the run&lt;/<span class="pl-ent">b</span>&gt;&lt;/<span class="pl-ent">td</span>&gt;</pre></div>
<h3>
<a id="user-content-rich-text-css-styles" class="anchor" href="#rich-text-css-styles" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Rich Text CSS Styles</h3>
<p>Excel supports a limited subset of CSS styles in rich text:</p>
<table>
<thead>
<tr>
<th align="left">Excel feature</th>
<th align="left">CSS Style</th>
</tr>
</thead>
<tbody>
<tr>
...
<td align="left">
<code>font-weight</code>: <code>bold</code> or <code>700</code>
</td>
</tr>
<tr>
...
<td align="left">
<code>text-decoration</code>: <code>underline</code>
</td>
</tr>
<tr>
<td align="left">Strike-through</td>
<td align="left">
<code>text-decoration</code>: <code>line-through</code>
</td>
</tr>
<tr>
<td align="left">Text Color</td>
<td align="left">
<code>color</code>: CSS Level 1 name or RGB(A)</td>
</tr>
<tr>
<td align="left">Font Name</td>
<td align="left">
<code>font-family</code>: first entry</td>
</tr>
<tr>
<td align="left">Font Size</td>
<td align="left">
<code>font-size</code> with unit (<code>px</code> or <code>pt</code>)</td>
</tr>
<tr>
<td align="left">Subscript</td>
<td align="left">
<code>vertical-align</code>: <code>sub</code>
</td>
</tr>
<tr>
<td align="left">Superscript</td>
<td align="left">
<code>vertical-align</code>: <code>super</code>
</td>
</tr>
</tbody>
</table>
<p>Since CSS only supports one <code>vertical-align</code> style for an element, the best way
to specify subscript/superscript with vertical alignment is to use a span:</p>
<div class="highlight highlight-text-html-basic"><pre>&lt;<span class="pl-ent">td</span> <span class="pl-e">style</span>=<span class="pl-s"><span class="pl-pds">"</span><span class="pl-s1"><span class="pl-c1"><span class="pl-c1">vertical-align</span></span>: <span class="pl-c1">middle</span></span><span class="pl-pds">"</span></span>&gt;
  &lt;<span class="pl-ent">span</span> <span class="pl-e">style</span>=<span class="pl-s"><span class="pl-pds">"</span><span class="pl-s1"><span class="pl-c1"><span class="pl-c1">vertical-align</span></span>: <span class="pl-c1">sub</span>; <span class="pl-c1"><span class="pl-c1">font-size</span></span>: <span class="pl-c1">.83<span class="pl-k">em</span></span></span><span class="pl-pds">"</span></span>&gt;
    This text will be subscripted in a cell that is middle-aligned
&lt;/<span class="pl-ent">span</span>&gt;&lt;/<span class="pl-ent">td</span>&gt;</pre></div>
<p>Excel automatically applies font scaling to subscript and superscript, so both
should be specified with <code>font-size: .83em</code> to ensure proper sizing.</p>
<h3>
<a id="user-content-cell-level-css-styles" class="anchor" href="#cell-level-css-styles" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Cell-Level CSS Styles</h3>
<p>Other cell features are only supported at the cell or row level</p>
<table>
<thead>
<tr>
<th align="left">Excel feature</th>
<th align="left">CSS TD Style</th>
</tr>
</thead>
<tbody>
<tr>
<td align="left">Horizontal alignment</td>
<td align="left">
<code>text-align</code>: <code>left</code> or <code>center</code> or <code>right</code>
</td>
</tr>
<tr>
<td align="left">Vertical alignment</td>
<td align="left">
<code>vertical-align</code>: <code>top</code> or <code>middle</code> or <code>bottom</code>
</td>
</tr>
<tr>
<td align="left">Background Fill</td>
<td align="left"><code>background-color</code></td>
</tr>
<tr>
<td align="left">Column width</td>
<td align="left">
<code>width</code> for non-merge cells</td>
</tr>
<tr>
<td align="left">Row height</td>
<td align="left">
<code>height</code> of containing TR element</td>
</tr>
</tbody>
</table>
<p>The Wrap Text property is automatically enabled when a newline is detected.
Normally <code>&lt;br/&gt;</code> tags are used, but if <code>white-space</code> is set to <code>pre</code> or any
related setting then newline characters are correctly interpreted.</p>
<h3>
<a id="user-content-borders" class="anchor" href="#borders" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Borders</h3>
<p>By default, the table borders are ignored.  Passing the option <code>borders: true</code>
to <code>table_to_book</code> or <code>table_to_sheet</code> will read the border styles:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c"><span class="pl-c">/*</span> default ignores borders <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> ws_no_borders <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">table_to_sheet</span>(table_elt);

<span class="pl-c"><span class="pl-c">/*</span> pass borders: true in the options object to read border styles <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> ws_with_borders <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">table_to_sheet</span>(table_elt, { borders<span class="pl-k">:</span> <span class="pl-c1">true</span> });</pre></div>
<h3>
<a id="user-content-dates" class="anchor" href="#dates" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Dates</h3>
<p>V8 (used by Chrome and NodeJS) and other JavaScript engines are extremely
aggressive in parsing date strings.  For example:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c"><span class="pl-c">/*</span> V8 thinks this is Mon Jan 01 2001 <span class="pl-c">*/</span></span>
<span class="pl-k">new</span> <span class="pl-en">Date</span>(<span class="pl-s"><span class="pl-pds">"</span>This is not a date 1<span class="pl-pds">"</span></span>);</pre></div>
<p>The text values in each cell is tested for date feasibility through the engine's
default <code>Date.parse</code> mechanism.  This is not always correct.  To specifically
suppress the Date parsing, set <code>rawDates: true</code>:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> ws_no_dates <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">table_to_sheet</span>(table_elt, { rawDates<span class="pl-k">:</span> <span class="pl-c1">true</span> });</pre></div>
<h3>
<a id="user-content-aria-compliance" class="anchor" href="#aria-compliance" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>ARIA Compliance</h3>
<p>Nodes with the <code>aria-hidden="true"</code> attribute are automatically discarded.  All
font icons using <code>&lt;I&gt;</code> tags should be marked with the attribute!</p>
<h3>
<a id="user-content-writing-to-a-specific-location-in-the-worksheet" class="anchor" href="#writing-to-a-specific-location-in-the-worksheet" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Writing to a specific location in the Worksheet</h3>
<p>The <code>origin</code> option specifies the starting cell.  It is expected to be one of:</p>
<table>
<thead>
<tr>
...
<p>For example, to start writing the table starting at cell A3:</p>
<pre><code>var ws_A3 = XLSX.utils.table_to_sheet(table_elt, { origin: "A3" });
</code></pre>
<h2>
...
<h3>
<a id="user-content-file-from-scratch" class="anchor" href="#file-from-scratch" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>File from Scratch</h3>
<p>The most common use case involves cleaning up an export from a data store:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> <span class="pl-c1">XLSX</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">"</span>@sheet/&lt;replace with your ID&gt;<span class="pl-pds">"</span></span>);

<span class="pl-c"><span class="pl-c">/*</span> Build up a worksheet from your data <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> ws <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">aoa_to_sheet</span>([
  [<span class="pl-s"><span class="pl-pds">"</span>Item<span class="pl-pds">"</span></span>, <span class="pl-s"><span class="pl-pds">"</span>Price<span class="pl-pds">"</span></span>]
]);
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_add_json</span>(ws, [
  { Item<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>abc<span class="pl-pds">"</span></span>, Price<span class="pl-k">:</span> <span class="pl-c1">1.23</span> },
...
<span class="pl-c"><span class="pl-c">/*</span> Bold the headers <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>A1:B1<span class="pl-pds">"</span></span>, {
  bold<span class="pl-k">:</span> <span class="pl-c1">true</span>
});

<span class="pl-c"><span class="pl-c">/*</span> Set the format for the visible cells in the price column <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> range <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">decode_range</span>(ws[<span class="pl-s"><span class="pl-pds">'</span>!ref<span class="pl-pds">'</span></span>]);
<span class="pl-smi">range</span>.<span class="pl-smi">s</span>.<span class="pl-smi">c</span> <span class="pl-k">=</span> <span class="pl-c1">1</span>; <span class="pl-c"><span class="pl-c">//</span> start from second col</span>
<span class="pl-smi">range</span>.<span class="pl-smi">e</span>.<span class="pl-smi">c</span> <span class="pl-k">=</span> <span class="pl-c1">1</span>; <span class="pl-c"><span class="pl-c">//</span> end on the second col</span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, range, {
  z<span class="pl-k">:</span> <span class="pl-s"><span class="pl-pds">"</span>0.00<span class="pl-pds">"</span></span> <span class="pl-c"><span class="pl-c">//</span> decimal with 2 places</span>
});

<span class="pl-c"><span class="pl-c">/*</span> Write File <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> wb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">book_new</span>();
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">book_append_sheet</span>(wb, ws, <span class="pl-s"><span class="pl-pds">"</span>Test<span class="pl-pds">"</span></span>);
<span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>e1.xlsx<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span> <span class="pl-c1">true</span>});</pre></div>
<h3>
<a id="user-content-spicing-up-csv-exports" class="anchor" href="#spicing-up-csv-exports" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Spicing up CSV Exports</h3>
<p>Another common use case involves cleaning up a data export from another process:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> <span class="pl-c1">XLSX</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">"</span>@sheet/&lt;replace with your ID&gt;<span class="pl-pds">"</span></span>); <span class="pl-c"><span class="pl-c">//</span> node or webpack</span>

<span class="pl-c"><span class="pl-c">/*</span> Read the file <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> wb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>e2.csv<span class="pl-pds">"</span></span>);
<span class="pl-k">var</span> ws <span class="pl-k">=</span> <span class="pl-smi">wb</span>.<span class="pl-smi">Sheets</span>[<span class="pl-smi">wb</span>.<span class="pl-smi">SheetNames</span>[<span class="pl-c1">0</span>]];

<span class="pl-c"><span class="pl-c">/*</span> Find the header row <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> range <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">decode_range</span>(ws[<span class="pl-s"><span class="pl-pds">'</span>!ref<span class="pl-pds">'</span></span>]);
<span class="pl-smi">range</span>.<span class="pl-smi">s</span>.<span class="pl-smi">r</span> <span class="pl-k">=</span> <span class="pl-c1">0</span>; <span class="pl-smi">range</span>.<span class="pl-smi">e</span>.<span class="pl-smi">r</span> <span class="pl-k">=</span> <span class="pl-c1">0</span>; <span class="pl-c"><span class="pl-c">//</span> restrict to the first row</span>
...
<span class="pl-c"><span class="pl-c">/*</span> Freeze first row <span class="pl-c">*/</span></span>
ws[<span class="pl-s"><span class="pl-pds">"</span>!freeze<span class="pl-pds">"</span></span>] <span class="pl-k">=</span> <span class="pl-s"><span class="pl-pds">"</span>A2<span class="pl-pds">"</span></span>;

<span class="pl-c"><span class="pl-c">/*</span> Write to XLSX <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>e2.xlsx<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span> <span class="pl-c1">true</span>});</pre></div>
<h3>
<a id="user-content-modifying-existing-files" class="anchor" href="#modifying-existing-files" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Modifying Existing Files</h3>
<p>Read in the file with <code>cellStyles:true</code> to initialize the styles data:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> <span class="pl-c1">XLSX</span> <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">"</span>@sheet/&lt;replace with your ID&gt;<span class="pl-pds">"</span></span>);

<span class="pl-c"><span class="pl-c">/*</span> read the file from the first export <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> wb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>e1.xlsx<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span><span class="pl-c1">true</span>});
<span class="pl-c"><span class="pl-c">/*</span> get the first worksheet <span class="pl-c">*/</span></span>
<span class="pl-k">var</span> ws <span class="pl-k">=</span> <span class="pl-smi">wb</span>.<span class="pl-smi">Sheets</span>[<span class="pl-smi">wb</span>.<span class="pl-smi">SheetNames</span>[<span class="pl-c1">0</span>]];
<span class="pl-c"><span class="pl-c">/*</span> turn off bold <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">sheet_set_range_style</span>(ws, <span class="pl-s"><span class="pl-pds">"</span>A1:B1<span class="pl-pds">"</span></span>, {bold<span class="pl-k">:</span> <span class="pl-c1">false</span>});

<span class="pl-c"><span class="pl-c">/*</span> Write to XLSX <span class="pl-c">*/</span></span>
<span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>e3.xlsx<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span> <span class="pl-c1">true</span>});</pre></div>
<h3>
<a id="user-content-exporting-an-html-table-on-the-dom" class="anchor" href="#exporting-an-html-table-on-the-dom" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Exporting an HTML TABLE on the DOM</h3>
<p><code>table_to_book</code> and <code>table_to_sheet</code> automatically process CSS styles:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> dom_elt <span class="pl-k">=</span> <span class="pl-c1">document</span>.<span class="pl-c1">getElementById</span>(<span class="pl-s"><span class="pl-pds">'</span>data-table<span class="pl-pds">'</span></span>);
<span class="pl-k">var</span> wb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">table_to_book</span>(dom_elt);
<span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>export.xlsx<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span><span class="pl-c1">true</span>});</pre></div>
<p>This technique works in JSDOM for server-side applications:</p>
<details>
...
<span class="pl-k">const</span> { <span class="pl-c1">JSDOM</span> } <span class="pl-k">=</span> <span class="pl-c1">require</span>(<span class="pl-s"><span class="pl-pds">'</span>jsdom<span class="pl-pds">'</span></span>);

<span class="pl-c"><span class="pl-c">/*</span> load HTML into the DOM <span class="pl-c">*/</span></span>
<span class="pl-k">const</span> <span class="pl-c1">dom</span> <span class="pl-k">=</span> <span class="pl-k">new</span> <span class="pl-en">JSDOM</span>(<span class="pl-smi">fs</span>.<span class="pl-en">readFileSync</span>(<span class="pl-s"><span class="pl-pds">"</span>table.html<span class="pl-pds">"</span></span>).<span class="pl-c1">toString</span>());
<span class="pl-k">const</span> <span class="pl-c1">elt</span> <span class="pl-k">=</span> <span class="pl-smi">dom</span>.<span class="pl-smi">window</span>.<span class="pl-smi">document</span>.<span class="pl-c1">querySelector</span>(<span class="pl-s"><span class="pl-pds">"</span>#table<span class="pl-pds">"</span></span>); <span class="pl-c"><span class="pl-c">//</span> use your table id</span>

<span class="pl-c"><span class="pl-c">/*</span> to detect styles, getComputedStyle has to be visible <span class="pl-c">*/</span></span>
getComputedStyle <span class="pl-k">=</span> <span class="pl-smi">dom</span>.<span class="pl-smi">window</span>.<span class="pl-smi">getComputedStyle</span>;

<span class="pl-c"><span class="pl-c">/*</span> generate workbook using table_to_book and export <span class="pl-c">*/</span></span>
<span class="pl-k">const</span> <span class="pl-c1">wb</span> <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">table_to_book</span>(elt);
<span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>tablexport.xlsx<span class="pl-pds">"</span></span>, {cellStyles<span class="pl-k">:</span><span class="pl-c1">true</span>});</pre></div>
<p>There are known issues with JSDOM and inheritance in <code>getComputedStyle</code>, so deep
nested styles should be avoided when possible.  Prefer explicit styling:</p>
<div class="highlight highlight-text-html-basic"><pre><span class="pl-c"><span class="pl-c">&lt;!--</span> works in browsers but problematic in JSDOM <span class="pl-c">--&gt;</span></span>
&lt;<span class="pl-ent">td</span>&gt;normal &lt;<span class="pl-ent">b</span>&gt;B &lt;<span class="pl-ent">i</span>&gt;BI&lt;/<span class="pl-ent">i</span>&gt;&lt;/<span class="pl-ent">b</span>&gt;&lt;/<span class="pl-ent">td</span>&gt;

<span class="pl-c"><span class="pl-c">&lt;!--</span> works in browsers and JSDOM<span class="pl-c">--&gt;</span></span>
&lt;<span class="pl-ent">style</span>&gt;<span class="pl-s1"></span>
<span class="pl-s1"><span class="pl-c"><span class="pl-c">/*</span> vertical alignment <span class="pl-c">*/</span></span></span>
<span class="pl-s1"><span class="pl-ent">TD</span> { <span class="pl-c1"><span class="pl-c1">vertical-align</span></span>: <span class="pl-c1">middle</span>; }</span>
<span class="pl-s1"></span>
<span class="pl-s1"><span class="pl-c"><span class="pl-c">/*</span> styling <span class="pl-c">*/</span></span></span>
<span class="pl-s1"><span class="pl-e">.bold</span> { <span class="pl-c1"><span class="pl-c1">font-weight</span></span>: <span class="pl-c1">bold</span>; }</span>
<span class="pl-s1"><span class="pl-e">.italic</span> { <span class="pl-c1"><span class="pl-c1">font-style</span></span>: <span class="pl-c1">italic</span>; }</span>
<span class="pl-s1"></span>&lt;/<span class="pl-ent">style</span>&gt;

&lt;<span class="pl-ent">td</span>&gt;normal &lt;<span class="pl-ent">span</span> <span class="pl-e">class</span>=<span class="pl-s"><span class="pl-pds">"</span>bold<span class="pl-pds">"</span></span>&gt;B&lt;/<span class="pl-ent">span</span>&gt; &lt;<span class="pl-ent">span</span> <span class="pl-e">class</span>=<span class="pl-s"><span class="pl-pds">"</span>bold italic<span class="pl-pds">"</span></span>&gt;BI&lt;/<span class="pl-ent">span</span>&gt;&lt;/<span class="pl-ent">td</span>&gt;</pre></div>
</details>
<h2>
<a id="user-content-template-refresh" class="anchor" href="#template-refresh" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Template Refresh</h2>
<p>The default behavior is to parse files into a JS representation and write that
...
keeping everything intact!</p>
<p>For this to happen, the entire representation of the original file is preserved.
...
available in template operations.</p>
<h3>
...
<p>The <code>readFile</code> function accepts a <code>template</code> argument that adds additional
metadata to the workbook:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">var</span> wb <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-en">readFile</span>(<span class="pl-s"><span class="pl-pds">"</span>test.xlsx<span class="pl-pds">"</span></span>, {template<span class="pl-k">:</span> <span class="pl-c1">true</span>});</pre></div>
<p>The <code>writeFile</code> function also accepts a <code>template</code> argument that uses template
metadata when writing to file:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-en">writeFile</span>(wb, <span class="pl-s"><span class="pl-pds">"</span>out.xlsx<span class="pl-pds">"</span></span>, {template<span class="pl-k">:</span> <span class="pl-c1">true</span>});</pre></div>
<h3>
<a id="user-content-editing-cell-values" class="anchor" href="#editing-cell-values" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Editing Cell Values</h3>
<p>The normal utility functions can be used to inspect the workbook.  To make
changes to the template, <code>template_set_aoa</code> takes an array of arrays of values:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">template_set_aoa</span>(wb, wsname, <span class="pl-s"><span class="pl-pds">"</span>A2:C2<span class="pl-pds">"</span></span>, [[<span class="pl-c1">1</span>,<span class="pl-c1">2</span>,<span class="pl-c1">3</span>]]);</pre></div>
<p>The worksheet can be specified as a worksheet object or an index or name.  The
range can be specified as a string or a proper range object or the top-left
cell address.</p>
<p>This will also update the underlying worksheet object.</p>
<p>Holes in the array will not be assigned.  For example, the following example
will set cells A2 and C2 but skip B2:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">template_set_aoa</span>(wb, wsname, <span class="pl-s"><span class="pl-pds">"</span>A2:C2<span class="pl-pds">"</span></span>, [[<span class="pl-c1">1</span>, <span class="pl-c"><span class="pl-c">/*</span> empty <span class="pl-c">*/</span></span> ,<span class="pl-c1">3</span>]]);</pre></div>
<p>By default, the method only changes the specified values.  To ensure that a cell
is untouched, either create an array hole or explicitly specify <code>undefined</code>. To
erase the existing values, set the values to <code>null</code>.  The following function
erases a range:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-k">function</span> <span class="pl-en">erase</span>(<span class="pl-smi">wb</span>, <span class="pl-smi">wsname</span>, <span class="pl-smi">range</span>) {
  <span class="pl-k">if</span>(<span class="pl-k">typeof</span> range <span class="pl-k">==</span> <span class="pl-s"><span class="pl-pds">"</span>string<span class="pl-pds">"</span></span>) range <span class="pl-k">=</span> <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">decode_range</span>(range);

  <span class="pl-c"><span class="pl-c">//</span> make array of arrays of undefined</span>
  <span class="pl-k">var</span> row <span class="pl-k">=</span> <span class="pl-c1">Array</span>.<span class="pl-en">from</span>({length<span class="pl-k">:</span> <span class="pl-smi">range</span>.<span class="pl-smi">e</span>.<span class="pl-smi">c</span> <span class="pl-k">-</span> <span class="pl-smi">range</span>.<span class="pl-smi">s</span>.<span class="pl-smi">c</span> <span class="pl-k">+</span> <span class="pl-c1">1</span>}, () <span class="pl-k">=&gt;</span> <span class="pl-c1">null</span>);
  <span class="pl-k">var</span> aoa <span class="pl-k">=</span> <span class="pl-c1">Array</span>.<span class="pl-en">from</span>({length<span class="pl-k">:</span> <span class="pl-smi">range</span>.<span class="pl-smi">e</span>.<span class="pl-smi">r</span> <span class="pl-k">-</span> <span class="pl-smi">range</span>.<span class="pl-smi">s</span>.<span class="pl-smi">r</span> <span class="pl-k">+</span> <span class="pl-c1">1</span>}, () <span class="pl-k">=&gt;</span> row);

  <span class="pl-c"><span class="pl-c">//</span> set each cell in the range</span>
  <span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">template_set_aoa</span>(wb, wsname, range, aoa);
}</pre></div>
<h3>
<a id="user-content-adding-and-removing-worksheets" class="anchor" href="#adding-and-removing-worksheets" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Adding and Removing Worksheets</h3>
<p><code>template_book_append_sheet</code> will add a worksheet to the end of the file based
on the specified worksheet object, equivalent to <code>book_append_sheet</code>:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">template_book_append_sheet</span>(wb, ws, name);</pre></div>
<p><code>template_book_delete_sheet</code> will remove a worksheet and adjust the template:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">template_book_delete_sheet</span>(wb, wsname);</pre></div>
<details>
  <summary><b>Delete Caveats</b> (click to show)</summary>
<p>The delete method will not attempt to correct formulae or other deep references,
and should only be used when known to be safe.</p>
<p>Defined names referencing the worksheet will be removed.</p>
</details>
<h3>
<a id="user-content-worksheet-properties" class="anchor" href="#worksheet-properties" aria-hidden="true"><span aria-hidden="true" class="octicon octicon-link"></span></a>Worksheet Properties</h3>
<p>Sheet visibility can be adjusted with <code>template_set_sheet_visibility</code>:</p>
<div class="highlight highlight-source-js"><pre><span class="pl-c1">XLSX</span>.<span class="pl-smi">utils</span>.<span class="pl-en">template_set_sheet_visibility</span>(wb, wsname, vis);</pre></div>
<p>where <code>vis</code> is one of the following values:</p>
<table>
<thead>
<tr>
